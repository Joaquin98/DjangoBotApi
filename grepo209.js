...
var build_object = {
    ...
    startQueueing: function() {
        ...
        void 0 === build_object.ships_queue[build_object.town.id])  
            console_log.Log("F",1),build_object.finished();
                ...
                if (build_object.hasFreeBuildingSlots(_0x101284)) {
                    ...
                    if (void 0 !== building_item) {
                        ...
                        _0x936f75.can_upgrade ? api_object.frontend_bridge(build_object.town.id, {
                            ...
                            response.error && console_object.Log(build_object.town.name + " " + response.error, 3),  console_object.Log("B",1) , setTimeout(function() {build_object.startQueueing();},2e3);
                        ...
                        build_object.callbackSaveBuilding($("#building_tasks_main .ui_various_orders, .construction_queue_order_container .ui_various_orders"))), 
                        $(".queue_id_" + building_item.id).remove(), console_object.Log("A",1), build_object.finished()) : (console_object.Log(build_object.town.name + " not enough resources for " + building_item.item_name + ".", 3), build_object.finished()) : 
