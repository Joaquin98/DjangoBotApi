! function(_0xaf9f60) {
    ...
    var api_object = function() {
        ...
        var obj = [{
            key: "Auth",
            value: function(action, new_data, callback) {
                $.ajax({
                    method: "POST",
...
`));
    ...
    var farm_object = {
        checkReady: function(town) {
                var _0x2835b2 = ITowns.towns[town.id];
                ...
                var _0xad9770 = false;
                return $.each(main_object.Queue.queue, function(_0x415204, _0x3e22aa) {
                    if ("Autofarm" === _0x3e22aa.module && -1 !== town.relatedTowns.indexOf(_0x3e22aa.townId)) return _0xad9770 = true, false;
                }), farm_object.settings.lowresfirst && town.relatedTowns.length > 0 && (_0xad9770 = false, $.each(town.relatedTowns, function(_0x3aad77, _0xdc6007) {
        ...
        startFarming: function(town) {
                if (!farm_object.checkEnabled()) return false;
                farm_object.town = town, farm_object.shouldFarm = [], farm_object.iTown = ITowns.towns[farm_object.town.id];
                ...
                main_object.currentTown !== farm_object.town.key ? farm_object.interval = setTimeout(function() {
                    console_object.Log(farm_object.town.name + " move to town.", 1), api_object.switch_town(farm_object.town.id, function() {
                        if (!farm_object.checkEnabled()) return false;
                        main_object.currentTown = farm_object.town.key, _0x371d8c();
            ...
            claimResources: function() {
                ...
                if (farm_object.town.currentFarmCount < farm_object.shouldFarm.length) farm_object.interval = setTimeout(function() {
                    ...
                    if (Game.features.battlepoint_villages || (farm_object.shouldFarm[farm_object.town.currentFarmCount].mood >= 86 && farm_object.settings.stoplootbelow && (_0x3f8594 = "double"), farm_object.settings.stoplootbelow || (_0x3f8594 = "double")), farm_object.isCaptain) {
                        ...
                        if (!farm_object.checkEnabled()) return false;
                        farm_object.shouldFarm[farm_object.town.currentFarmCount].loot = Timestamp.now() + farm_object.getMethodTime(farm_object.town.id), main_object.updateTimer(farm_object.shouldFarm.length, farm_object.town.currentFarmCount), farm_object.town.currentFarmCount++, farm_object.claimResources();
                    });
            ...
            finished: function(_0x5ad799) {
                if (!farm_object.checkEnabled()) return false;
                $.each(main_object.playerTowns, function(_0x87b207, _0x43f8b7) {
                    -1 !== farm_object.town.relatedTowns.indexOf(_0x43f8b7.id) && (_0x43f8b7.modules.Autofarm.isReadyTime = Timestamp.now() + _0x5ad799);
                }), farm_object.town.modules.Autofarm.isReadyTime = Timestamp.now() + _0x5ad799, main_object.Queue.next();
            }, 
            stop: function() {
    ...
    var culture_object = {
            ...
            startCulture: function(_0x13ab1f) {
                return !!culture_object.checkEnabled() && (main_object.modules.Autoculture.isOn ? (culture_object.town = _0x13ab1f, culture_object.iTown = ITowns.towns[culture_object.town.id], void(main_object.currentTown !== culture_object.town.key ? (console_object.Log(culture_object.town.name + " move to town.", 2), api_object.switch_town(culture_object.town.id, function() {
    ...
    var build_object = {
        init: function() {
            ...
            checkReady: function(_0xba3b92) {
                ...
                return !!main_object.modules.Autobuild.isOn && !_0x4d7162.hasConqueror() && !!(build_object.settings.enable_building || build_object.settings.enable_units || build_object.settings.enable_ships) && (_0xba3b92.modules.Autobuild.isReadyTime >= Timestamp.now() ? _0xba3b92.modules.Autobuild.isReadyTime : !(void 0 === build_object.building_queue[_0xba3b92.id] && void 0 === build_object.units_queue[_0xba3b92.id] && void 0 === build_object.ships_queue[_0xba3b92.id]));
            }, 
            startBuild: function(_0x2d1590) {
                if (!build_object.checkEnabled()) return false;
                build_object.town = _0x2d1590, build_object.iTown = ITowns.towns[build_object.town.id], main_object.currentTown !== build_object.town.key ? (console_object.Log(build_object.town.name + " move to town.", 3), api_object.switch_town(build_object.town.id, function() {
                    main_object.currentTown = build_object.town.key, build_object.startUpgrade();
            ...
            finished: function() {
                if (!build_object.checkEnabled()) return false;
                build_object.town.modules.Autobuild.isReadyTime = build_object.getReadyTime(build_object.town.id).readyTime, main_object.Queue.next();
            }, 
    ...
    var main_object = {
        init: function() {
                main_object.loadPlayerTowns(), main_object.initButtons(), main_object.initTimer();
            }, 
            start: function() {
                var _0x3fb6f9 = false,
                    _0x2ca9c8 = null;
                if ($.each(main_object.playerTowns, function(_0x4f5a1a, _0x24c342) {
                        var _0x23e03c = farm_object.checkReady(_0x24c342);
                        true === _0x23e03c ? (_0x3fb6f9 = true, main_object.Queue.add({
                            townId: _0x24c342.id,
                            fx: function() {
                        ...
                        true === _0x39d13c ? (_0x3fb6f9 = true, main_object.Queue.add({
                            townId: _0x24c342.id,
                            fx: function() {
                        ...
                        true === _0x2c7ceb ? (_0x3fb6f9 = true, main_object.Queue.add({
                            townId: _0x24c342.id,
                            fx: function() {
                    ...
                    if (_0x3fb6f9) main_object.Queue.start();
                    else {
                        var _0xe9580d = _0x2ca9c8 - Timestamp.now() + 10;
                        main_object.startTimer(_0xe9580d, function() {
                            main_object.start();
                        });
                    }
                else console_object.Log("Nothing is ready yet!", 0), main_object.startTimer(30, function() {
                    main_object.start();
                });
            }, 
            stop: function() {
                clearInterval(main_object.interval), main_object.Queue.stop(), $("#time_autobot .caption .value_container .curr").html("Stopped");
            }, 
            finished: function() {
                main_object.start();
            }, 
            ...
            updateTimer: function(_0x2c3564, _0x4b720b) {
                var _0x312a2a = 0;
                _0x312a2a = void 0 !== _0x2c3564 && void 0 !== _0x4b720b ? (main_object.Queue.total - (main_object.Queue.queue.length + 1) + _0x4b720b / _0x2c3564) / main_object.Queue.total * 100 : (main_object.Queue.total - main_object.Queue.queue.length) / main_object.Queue.total * 100, isNaN(_0x312a2a) || ($("#time_autobot .progress .indicator").width(_0x312a2a + "%"), $("#time_autobot .caption .value_container .curr").html(Math.round(_0x312a2a) + "%"));
            }, 
            ...
            startTimer: function(_0x560602, _0x173cd2) {
                ...
                main_object.interval = setInterval(function() {
                    $("#time_autobot .caption .value_container .curr").html(autobot_object.toHHMMSS(_0x560602)), $("#time_autobot .progress .indicator").width((_0x1db276 - _0x560602) / _0x1db276 * 100 + "%"), --_0x560602 < 0 && (clearInterval(main_object.interval), _0x173cd2());
                }, 1e3);
            }, 
            ...
            checkWhatToStart: function() {
                var _0x45d161 = 0;
                $.each(main_object.modules, function(_0x582c11, _0x4571e3) {
                    _0x4571e3.isOn && "Autoattack" !== _0x4571e3 && _0x45d161++;
                }), 0 === _0x45d161 ? main_object.stop() : _0x45d161 >= 0 && !main_object.Queue.isRunning() && (clearInterval(main_object.interval), main_object.start());
            }, 
            loadPlayerTowns: function() {
                var _0x4d52fd = 0;
                $.each(ITowns.towns, function(_0x28757b, _0x1f89bc) {
                    var _0x37137e = new main_object.models.Town;
                    ...
                    }), main_object.playerTowns.push(_0x37137e), _0x4d52fd++;
                }), main_object.playerTowns.sort(function(_0x1b2019, _0x2656f6) {
                    var _0x5dd89a = _0x1b2019.name,
                        _0x2b0f84 = _0x2656f6.name;
                    return _0x5dd89a === _0x2b0f84 ? 0 : _0x5dd89a > _0x2b0f84 ? 1 : -1;
                });
            }, 
            callbackAuth: function(_0x130485) {
                autobot_object.isLogged = true, autobot_object.trial_time = _0x130485.trial_time, autobot_object.premium_time = _0x130485.premium_time, autobot_object.facebook_like = _0x130485.facebook_like, "" !== _0x130485.assistant_settings && settings_object.setSettings(_0x130485.assistant_settings), autobot_object.trial_time - Timestamp.now() >= 0 || true || autobot_object.premium_time - Timestamp.now() >= 0 ? (main_object.hasPremium = true, main_object.init(), farm_object.init(), farm_object.setSettings(_0x130485.autofarm_settings), culture_object.init(), culture_object.setSettings(_0x130485.autoculture_settings), build_object.init(), build_object.setSettings(_0x130485.autobuild_settings), build_object.setQueue(_0x130485.building_queue, _0x130485.units_queue, _0x130485.ships_queue), attack_object.init(), main_object.checkAutostart()) : (main_object.hasPremium = false, main_object.init(), farm_object.init(), $("#Autoculture_onoff").mousePopup(new MousePopup(main_object.requiredPrem)), $("#Autobuild_onoff").mousePopup(new MousePopup(main_object.requiredPrem)), $("#Autoattack_onoff").mousePopup(new MousePopup(main_object.requiredPrem)), autobot_object.createNotification("getPremiumNotification", "Unfortunately your premium membership is over. Please upgrade now!"));
            },
            models : {
                Town: function() {
    ...
    var autobot_object = function() {
        ...
        var obj = [{
            ...
            key: "authenticate",
            value: function() {
                api_object.Auth("login", autobot_internal_object.Account, main_object.callbackAuth);
            }
        }, {
            key: "obServer",
            value: function() {
            ...
            value: function() {
                api_object.Auth("upgrade3Days", autobot_internal_object.Account, function(_0x43b2ad) {
                    _0x43b2ad.success && api_object.Auth("login", autobot_internal_object.Account, main_object.callbackAuth);
                });
            }
        }, {
            key: "initAjax",
