    ...
    init: function() {
        ...
        makeSelectbox: function() {
            ...
            $("#payment #information_paypal").append($("<div/>", {
                id : "price_number",
                style: "width: 100%; margin: 40px;font-weight: 700;font-size: 28px;line-height: 12px;text-align: center;color: #d49f0f"
            }).html($("#time_options").children(".active").children(".price").attr("price")));

            $("#payment #information_paypal").append($("<div/>", {
                id: "paypal-button",
                style: "width: 100%; overflow:scroll; height: 300px;"
            }));
