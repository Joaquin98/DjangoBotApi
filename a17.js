! function(_0xaf9f60) {
    ...
    var console_object = function() {
        ...
        var obj = [{
            ...
            value: function() {
                var _0x4de3b6 = $("<fieldset/>", {
                        ...
                        console_internal_object.LogScrollBottom();
                    })),
                    _0x5bb9f8 = _0x4de3b6.find(".terminal-output");
                return $.each(console_internal_object.Logs, function(_0x5773cf, _0x1dd55b) {
            ...
            value: function(_0x3944c8, _0x4650e0) {
                ...
                var _0x45e1f8 = new Date,
                    ...
                    _0x544b5d = $("<div/>").append($("<div/>", {
                        style: "width: 100%;"
                    }).html(_0x2e0345 + " - [" + console_internal_object.Types[_0x4650e0] + "]: " + _0x3944c8));
        ...
        list_to_object(console_internal_object, obj);
        return console_internal_object;
    }();
...
`));
    ...
    var autobot_object = function() {
        ...
        var obj = [{
            key: "init",
            value: function() {
                console_object.Log("Initialize Autobot", 0), autobot_internal_object.authenticate(), autobot_internal_object.obServer(), autobot_internal_object.isActive(), autobot_internal_object.setToolbox(), autobot_internal_object.initAjax(), autobot_internal_object.initMapTownFeature(), autobot_internal_object.fixMessage(), _0x325bca.init();
            }
        }, {
            key: "setToolbox",
            value: function() {
