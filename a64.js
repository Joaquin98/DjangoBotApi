        ...
        culture_object.interval = setTimeout(function() {
            ...
            api_object.building_place(culture_object.town.id, function(response) {
                ...
                ! function function_culture_callback(culture_option) {
                    ...
                    return culture_i++,console_object.Log("RE PROBLEMA ACA1" + ("party" !== culture_option.name) + " " + culture_object.settings.towns[culture_object.town.id].party  +" " +culture_object.checkAvailable(culture_object.town.id).party, 2), function_culture_callback(culture_options[culture_i]), false;
