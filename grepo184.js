    ...
    init: function() {
        ...
        getPremium: function() {
            ...
            if (autobot_object.isLogged) {
                ...
                autobot_object.botPremWnd = Layout.dialogWindow.open("", "Autobot v" + autobot_object.version + " - Premium", 700, 350, "", false), autobot_object.botPremWnd.setHeight([350]), autobot_object.botPremWnd.setPosition(["center", "center"]);
                var _0x1fc633 = $("<div/>", {
                    id: "payment"
                }).append($("<div/>", {
                    id: "left"
