...
`));
    ...
    var culture_object = {
            ...
            setSettings: function(_0x23bdf4) {
                "" !== _0x23bdf4 && null != _0x23bdf4 && $.extend(culture_object.settings, _0x23bdf4);
            }, 
            ...
            startCulture: function(_0x13ab1f) {
                return !!culture_object.checkEnabled() && (_0x35174a.modules.Autoculture.isOn ? (culture_object.town = _0x13ab1f, culture_object.iTown = ITowns.towns[culture_object.town.id], void(_0x35174a.currentTown !== culture_object.town.key ? (console_object.Log(culture_object.town.name + " move to town.", 2), api_object.switch_town(culture_object.town.id, function() {
                    if (!culture_object.checkEnabled()) return false;
                    _0x35174a.currentTown = culture_object.town.key, culture_object.start();
                })) : culture_object.start())) : (culture_object.finished(0), false));
            }, 
            start: function() {
                if (!culture_object.checkEnabled()) return false;
                culture_object.interval = setTimeout(function() {
                    void 0 !== culture_object.settings.towns[culture_object.town.id] && (console_object.Log(culture_object.town.name + " getting event information.", 2), api_object.building_place(culture_object.town.id, function(_0x2afe41) {
                        if (!culture_object.checkEnabled()) return false;
                        var _0x57703c = [];
                        _0x57703c.push({
                            name: "triumph",
                        ...
                        ! function _0x3b8221(_0x3b5c39) {
                            if (3 === _0x3ce62b) return _0x7aa6fc || console_object.Log(culture_object.town.name + " not ready yet.", 2), culture_object.finished(_0x1fc8ce), false;
                            if ("triumph" === _0x3b5c39.name && (!culture_object.settings.towns[culture_object.town.id].triumph || !culture_object.checkAvailable(culture_object.town.id).triumph || MM.getModelByNameAndPlayerId("PlayerKillpoints").getUnusedPoints() < 300)) return _0x3ce62b++, _0x3b8221(_0x57703c[_0x3ce62b]), false;
                            if (!("party" !== _0x3b5c39.name || culture_object.settings.towns[culture_object.town.id].party && culture_object.checkAvailable(culture_object.town.id).party)) return _0x3ce62b++, _0x3b8221(_0x57703c[_0x3ce62b]), false;
                            if (!("theater" !== _0x3b5c39.name || culture_object.settings.towns[culture_object.town.id].theater && culture_object.checkAvailable(culture_object.town.id).theater)) return _0x3ce62b++, _0x3b8221(_0x57703c[_0x3ce62b]), false;
                            ...
                            return "1" !== _0x3b5c39.element.find(".button, .button_new").data("enabled") ? (_0x3ce62b++, _0x3b8221(_0x57703c[_0x3ce62b]), false) : "1" === _0x3b5c39.element.find(".button, .button_new").data("enabled") ? (culture_object.interval = setTimeout(function() {
                                _0x7aa6fc = true, culture_object.startCelebration(_0x3b5c39, function(_0x512aee) {
            ...
            finished: function(_0x8c8523) {
                if (!culture_object.checkEnabled()) return false;
                culture_object.town.modules.Autoculture.isReadyTime = Timestamp.now() + _0x8c8523, _0x35174a.Queue.next();
            }, 
            checkEnabled: function() {
            ...
            contentSettings: function() {
                ...
                return _0x2bf6a6.find(".celebration.party").mousePopup(new MousePopup("Auto " + PopupFactory.texts.party)).on("click", function() {
                    ...
                    var _0x232038 = menu_object.button({
                        ...
                        }), culture_object.settings.autostart = $("#autoculture_autostart").prop("checked"), api_object.Auth("saveCulture", {
                            player_id: autobot_object.Account.player_id,
                            world_id: autobot_object.Account.world_id,
                            csrfToken: autobot_object.Account.csrfToken,
                            autoculture_settings: autobot_object.stringify(culture_object.settings)
                        }, culture_object.callbackSave);
                    });
    ...
    var build_object = {
        init: function() {
                console_object.Log("Initialize Autobuild", 3), build_object.initFunction(), build_object.initButton(), build_object.checkCaptain(), build_object.activateCss();
            }, 
            setSettings: function(_0x599218) {
                "" !== _0x599218 && null != _0x599218 && $.extend(build_object.settings, _0x599218);
            },
            activateCss: function() {
                $(".construction_queue_order_container").addClass("active");
            }, 
            setQueue: function(_0x1a7097, _0xea1553, _0x49ae6d) {
                "" !== _0x1a7097 && null != _0x1a7097 && (build_object.building_queue = _0x1a7097, build_object.initQueue($(".construction_queue_order_container"), "building")), "" !== _0xea1553 && null != _0xea1553 && (build_object.units_queue = _0xea1553), "" !== _0x49ae6d && null != _0x49ae6d && (build_object.ships_queue = _0x49ae6d);
            }, 
            calls: function(_0x986bda) {
                switch (_0x986bda) {
                    case "building_main/index":
                    case "building_main/build":
                    case "building_main/cancel":
                    case "building_main/tear_down":
                        build_object.windows.building_main_index(_0x986bda);
                        break;
                    case "building_barracks/index":
                    case "building_barracks/build":
                    case "building_barracks/cancel":
                    case "building_barracks/tear_down":
                        build_object.windows.building_barracks_index(_0x986bda);
                }
            }, 
            ...
            checkCaptain: function() {
                $(".advisor_frame.captain div").hasClass("captain_active") && (build_object.isCaptain = true), build_object.Queue = build_object.isCaptain ? 7 : 2;
            }, 
            checkReady: function(_0xba3b92) {
                var _0x4d7162 = ITowns.towns[_0xba3b92.id];
                return !!_0x35174a.modules.Autobuild.isOn && !_0x4d7162.hasConqueror() && !!(build_object.settings.enable_building || build_object.settings.enable_units || build_object.settings.enable_ships) && (_0xba3b92.modules.Autobuild.isReadyTime >= Timestamp.now() ? _0xba3b92.modules.Autobuild.isReadyTime : !(void 0 === build_object.building_queue[_0xba3b92.id] && void 0 === build_object.units_queue[_0xba3b92.id] && void 0 === build_object.ships_queue[_0xba3b92.id]));
            }, 
            startBuild: function(_0x2d1590) {
                if (!build_object.checkEnabled()) return false;
                build_object.town = _0x2d1590, build_object.iTown = ITowns.towns[build_object.town.id], _0x35174a.currentTown !== build_object.town.key ? (console_object.Log(build_object.town.name + " move to town.", 3), api_object.switch_town(build_object.town.id, function() {
                    _0x35174a.currentTown = build_object.town.key, build_object.startUpgrade();
                })) : build_object.startUpgrade();
            }, 
            startQueueing: function() {
                if (!build_object.checkEnabled()) return false;
                void 0 === build_object.building_queue[build_object.town.id] && void 0 === build_object.units_queue[build_object.town.id] && void 0 === build_object.ships_queue[build_object.town.id] && build_object.finished();
                var _0x13e2c9 = build_object.getReadyTime(build_object.town.id).shouldStart;
                "building" === _0x13e2c9 ? build_object.startBuildBuilding() : "unit" === _0x13e2c9 || "ship" === _0x13e2c9 ? build_object.startBuildUnits("unit" === _0x13e2c9 ? build_object.units_queue : build_object.ships_queue, _0x13e2c9) : build_object.finished();
            }, 
            ...
            startBuildUnits: function(_0x4708e5, _0x8cd49f) {
                if (!build_object.checkEnabled()) return false;
                if (void 0 !== _0x4708e5[build_object.town.id])
                    if (void 0 !== _0x4708e5[build_object.town.id]) {
                        var _0x4b274f = _0x4708e5[build_object.town.id][0];
                        GameDataUnits.getMaxBuildForSingleUnit(_0x4b274f.item_name) >= _0x4b274f.count ? build_object.interval = setTimeout(function() {
                            api_object.building_barracks(build_object.town.id, {
                                ...
                                if (_0x59fc24.error) console_object.Log(build_object.town.name + " " + _0x59fc24.error, 3);
                                else {
                                    if (build_object.town.id === Game.townId)
                                    ...
                                    console_object.Log('<span style="color: ' + ("unit" === _0x8cd49f ? "#ffe03d" : "#3dadff") + ';">Units - ' + _0x4b274f.count + " " + GameData.units[_0x4b274f.item_name].name_plural + " added.</span>", 3), api_object.Auth("removeItemQueue", {
                                        ...
                                        type: _0x8cd49f
                                    }, build_object.callbackSaveUnits($("#unit_orders_queue .ui_various_orders"), _0x8cd49f)), $(".queue_id_" + _0x4b274f.id).remove();
                                }
                                build_object.finished();
                            });
                        }, autobot_object.randomize(1e3, 2e3)) : (console_object.Log(build_object.town.name + " recruiting " + _0x4b274f.count + " " + GameData.units[_0x4b274f.item_name].name_plural + " not ready.", 3), build_object.finished());
                    } else build_object.finished();
                else build_object.finished();
            }, 
            startBuildBuilding: function() {
                if (!build_object.checkEnabled()) return false;
                void 0 !== build_object.building_queue[build_object.town.id] && build_object.building_queue[build_object.town.id] ? build_object.interval = setTimeout(function() {
                    console_object.Log(build_object.town.name + " getting building information.", 3), api_object.building_main(build_object.town.id, function(_0x101284) {
                        if (build_object.hasFreeBuildingSlots(_0x101284)) {
                            var _0x34fb0 = build_object.building_queue[build_object.town.id][0];
                            if (void 0 !== _0x34fb0) {
                                var _0x936f75 = build_object.getBuildings(_0x101284)[_0x34fb0.item_name];
                                _0x936f75.can_upgrade ? api_object.frontend_bridge(build_object.town.id, {
                                    ...
                                    if (_0x13e7ca.success) {
                                        ...
                                        console_object.Log('<span style="color: #ffa03d;">' + _0x34fb0.item_name.capitalize() + " - " + _0x13e7ca.success + "</span>", 3), api_object.Auth("removeItemQueue", {
                                            ...
                                            item_id: _0x34fb0.id,
                                            type: "building"
                                        }, build_object.callbackSaveBuilding($("#building_tasks_main .ui_various_orders, .construction_queue_order_container .ui_various_orders"))), $(".queue_id_" + _0x34fb0.id).remove();
                                    }
                                    _0x13e7ca.error && console_object.Log(build_object.town.name + " " + _0x13e7ca.error, 3), build_object.finished();
                                }) : _0x936f75.enough_population ? _0x936f75.enough_resources ? (console_object.Log(build_object.town.name + " " + _0x34fb0.item_name + " can not be started due dependencies.", 3), api_object.Auth("removeItemQueue", {
                                    player_id: autobot_object.Account.player_id,
                                    world_id: autobot_object.Account.world_id,
                                    csrfToken: autobot_object.Account.csrfToken,
                                    town_id: build_object.town.id,
                                    item_id: _0x34fb0.id,
                                    type: "building"
                                }, build_object.callbackSaveBuilding($("#building_tasks_main .ui_various_orders, .construction_queue_order_container .ui_various_orders"))), $(".queue_id_" + _0x34fb0.id).remove(), build_object.finished()) : (console_object.Log(build_object.town.name + " not enough resources for " + _0x34fb0.item_name + ".", 3), build_object.finished()) : (console_object.Log(build_object.town.name + " not enough population for " + _0x34fb0.item_name + ".", 3), build_object.finished());
                            } else build_object.finished();
                        } else console_object.Log(build_object.town.name + " no free building slots available.", 3), build_object.finished();
                    });
                }, autobot_object.randomize(1e3, 2e3)) : build_object.finished();
            }, 
            getReadyTime: function(_0x3d657c) {
                var _0x205ddb = {
                    building: {
                        queue: [],
                        timeLeft: 0
                ...
                return $.each(_0x205ddb, function(_0x3b0e1b) {
                    ("building" === _0x3b0e1b && void 0 !== build_object.building_queue[_0x3d657c] || "unit" === _0x3b0e1b && void 0 !== build_object.units_queue[_0x3d657c] || "ship" === _0x3b0e1b && void 0 !== build_object.ships_queue[_0x3d657c]) && (_0x11354b = _0x3b0e1b);
                    ...
                    readyTime: Timestamp.now() + (_0x5add01 > 0 ? _0x5add01 : +build_object.settings.timeinterval),
            ...
            finished: function() {
                if (!build_object.checkEnabled()) return false;
                build_object.town.modules.Autobuild.isReadyTime = build_object.getReadyTime(build_object.town.id).readyTime, _0x35174a.Queue.next();
            }, 
            checkInstantComplete: function(_0x16dd4b) {
                return build_object.instantBuyTown = false, $.each(MM.getOnlyCollectionByName("BuildingOrder").models, function(_0x595abe, _0x1d8a53) {
                    if (_0x16dd4b === _0x1d8a53.getTownId() && _0x1d8a53.getTimeLeft() < 300) return build_object.instantBuyTown = {
            ...
            callbackSaveBuilding: function(_0x48518f) {
                return function(_0x4133d6) {
                    _0x48518f.each(function() {
                        $(this).find(".empty_slot").remove(), _0x4133d6.item ? ($(this).append(build_object.buildingElement($(this), _0x4133d6.item)), build_object.setEmptyItems($(this))) : build_object.setEmptyItems($(this));
                    }), delete _0x4133d6.item, build_object.building_queue = _0x4133d6;
                };
            }, 
            ...
            initQueue: function(_0x16db32, _0x1e0879) {
                var _0x1a1d41 = _0x16db32.find(".ui_various_orders");
                _0x1a1d41.find(".empty_slot").remove(), "building" === _0x1e0879 && ($("#building_tasks_main").addClass("active"), void 0 !== build_object.building_queue[Game.townId] && $.each(build_object.building_queue[Game.townId], function(_0x36b276, _0x5a4925) {
                    _0x1a1d41.append(build_object.buildingElement(_0x1a1d41, _0x5a4925));
                })), "unit" === _0x1e0879 && ($("#unit_orders_queue").addClass("active"), void 0 !== build_object.units_queue[Game.townId] && $.each(build_object.units_queue[Game.townId], function(_0x43b4f9, _0x140c22) {
                    _0x1a1d41.append(build_object.unitElement(_0x1a1d41, _0x140c22, _0x1e0879));
                })), "ship" === _0x1e0879 && ($("#unit_orders_queue").addClass("active"), void 0 !== build_object.ships_queue[Game.townId] && $.each(build_object.ships_queue[Game.townId], function(_0x402a7d, _0x6070b8) {
                    _0x1a1d41.append(build_object.unitElement(_0x1a1d41, _0x6070b8, _0x1e0879));
                })), build_object.setEmptyItems(_0x1a1d41), _0x1a1d41.parent().mousewheel(function(_0x407414, _0x3e3ded) {
                    this.scrollLeft -= 30 * _0x3e3ded, _0x407414.preventDefault();
                });
            }, 
            initUnitOrder: function(_0x523ff8, _0x45df02) {
                ...
                if (_0x13a5c1.length >= 0 && (_0x15faa3.missing_building_dependencies.length >= 1 || _0x15faa3.missing_research_dependencies.length >= 1) && _0x13a5c1.hide(), 0 === _0x15faa3.missing_building_dependencies.length && 0 === _0x15faa3.missing_research_dependencies.length) {
                    var _0x40bbe0 = ITowns.towns[Game.townId],
                        ...
                        _0x6f1c3 = [];
                    _0x6f1c3.push(Math.floor(_0x40bbe0.getStorage() / _0x2df979)), _0x6f1c3.push(Math.floor((_0x40bbe0.getAvailablePopulation() - build_object.checkPopulationBeingBuild()) / _0x15faa3.population)), _0x15faa3.favor > 0 && _0x6f1c3.push(Math.floor(500 / _0x15faa3.favor));
                    ...
                    _0x4eb6e2 > 0 && _0x4eb6e2 >= _0x368776 && _0x523ff8.slider.setMax(_0x4eb6e2), 0 === _0x13a5c1.length ? (_0x13a5c1 = $("<a/>", {
                        ...
                        _0x49f41d.preventDefault(), build_object.addUnitQueueItem(_0x15faa3, _0x45df02);
                    })) : (_0x13a5c1.unbind("click"), _0x13a5c1.on("click", function(_0x4fb1e0) {
                        _0x4fb1e0.preventDefault(), build_object.addUnitQueueItem(_0x15faa3, _0x45df02);
            ...
            checkBuildingLevel: function(_0x5efcdb) {
                ...
                }), void 0 !== build_object.building_queue[Game.townId] && $(build_object.building_queue[Game.townId]).each(function(_0x391793, _0x12da94) {
            ...
            checkPopulationBeingBuild: function() {
                var _0x34a6a8 = 0;
                return void 0 !== build_object.units_queue[Game.townId] && $(build_object.units_queue[Game.townId].unit).each(function(_0x3c3144, _0x3f0a21) {
                    _0x34a6a8 += _0x3f0a21.count * GameData.units[_0x3f0a21.item_name].population;
                }), void 0 !== build_object.ships_queue[Game.townId] && $(build_object.ships_queue[Game.townId].ship).each(function(_0x5548b0, _0x26c22a) {
            ...
            callbackSaveUnits: function(_0x4282da, _0x36b7cf) {
                return function(_0x1d2338) {
                    console.log(_0x1d2338), "unit" === _0x36b7cf ? build_object.units_queue = _0x1d2338 : "ship" === _0x36b7cf && (build_object.ships_queue = _0x1d2338), _0x4282da.each(function() {
                        $(this).find(".empty_slot").remove(), _0x1d2338.item ? ($(this).append(build_object.unitElement($(this), _0x1d2338.item, _0x36b7cf)), build_object.setEmptyItems($(this)), delete _0x1d2338.item) : build_object.setEmptyItems($(this)), UnitOrder.selectUnit(UnitOrder.unit_id);
                    });
                };
            }, 
            setEmptyItems: function(_0x5ced05) {
                var _0x2a797b = 0,
            ...
            buildingElement: function(_0xf06a54, _0x8ae3d0) {
                return $("<div/>", {
                ...
                }).append('<span class="construction_queue_sprite arrow_green_ver"></span>' + build_object.checkBuildingLevel(_0x8ae3d0))))).append($("<div/>", {
                    ...
                    _0xe39ad9.preventDefault(), api_object.Auth("removeItemQueue", {
                        ...
                        type: "building"
                    }, build_object.callbackSaveBuilding($("#building_tasks_main .ui_various_orders, .construction_queue_order_container .ui_various_orders"))), $(".queue_id_" + _0x8ae3d0.id).remove();
                }).append($("<div/>", {
                    class: "left"
                })).append($("<div/>", {
                    class: "right"
            ...
            unitElement: function(_0x15ed7d, _0x4bb5da, _0xed46f8) {
                return $("<div/>", {
                    ...
                    _0x25fae1.preventDefault(), api_object.Auth("removeItemQueue", {
                        ...
                        type: _0xed46f8
                    }, build_object.callbackSaveUnits($("#unit_orders_queue .ui_various_orders"), _0xed46f8)), $(".queue_id_" + _0x4bb5da.id).remove();
                }).append($("<div/>", {
                    class: "left"
                })).append($("<div/>", {
                    class: "right"
                ...
                return $("<fieldset/>", {
                    ...
                    var _0x10bf19 = menu_object.button({
                        ...
                        build_object.settings.autostart = void 0 !== _0x487813.autobuild_autostart, build_object.settings.timeinterval = parseInt(_0x487813.autobuild_timeinterval), build_object.settings.autostart = void 0 !== _0x487813.autobuild_autostart, build_object.settings.enable_building = void 0 !== _0x487813.autobuild_building_enable, build_object.settings.enable_units = void 0 !== _0x487813.autobuild_barracks_enable, build_object.settings.enable_ships = void 0 !== _0x487813.autobuild_ships_enable, build_object.settings.instant_buy = void 0 !== _0x487813.autobuild_instant_buy, api_object.Auth("saveBuild", {
                            ...
                            world_id: autobot_object.Account.world_id,
                            csrfToken: autobot_object.Account.csrfToken,
                            autobuild_settings: autobot_object.stringify(build_object.settings)
                        }, build_object.callbackSaveSettings);
                    });
