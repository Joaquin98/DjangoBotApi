        ...
        return _0x2bb8ae = _0x59c65a, _0x264b07 = [{
            ...
            'value': function () {
                ...
                return _0x34d953.find('.autoattack_settings').append(function () {
                    ...
                    if (!_0x397f9e.checkPremium('captain')) return menu_object.button({
            ...
            'building_main_index': function () {
                if (GPWindowMgr && GPWindowMgr.getOpenFirst(Layout.wnd.TYPE_BUILDING)) {
                    ...
                    $.each($('#buildings .button_build.build_grey.build_up.small.bold'), function () {
                        ...
                        build_object.checkBuildingDepencencies(_0x5ab183, ITowns.getTown(Game.townId)).length <= 0x0 && -0x1 === $.inArray(_0x5ab183, _0x28ee9c) && $(this).removeClass('build_grey').addClass('build').html('Add to queue').on('click', function (_0x43fce6) {
        ...
        return _0x2baf0a = _0x53126f, _0xb66ef6 = [{
            ...
            'value': function (_0x273f2b) {
                ...
                _0x488ec6.removeClass('disabled'), _0x488ec6.on('click', function (_0x50cb90) {
                    ...
                    !0x0 === _0x53126f.modules[_0x273f2b].isOn ? (_0x53126f.modules[_0x273f2b].isOn = !0x1, _0x488ec6.removeClass('on'), _0x488ec6.find('span').mousePopup(new MousePopup('Start ' + _0x273f2b)), HumanMessage.success(_0x273f2b + ' is deactivated.'), console_object.Log(_0x273f2b + ' is deactivated.', 0x0), 'Autofarm' === _0x273f2b ? farm_object.stop() : 'Autoculture' === _0x273f2b ? culture_object.stop() : 'Autobuild' === _0x273f2b ? build_object.stop() : 'Autoattack' === _0x273f2b && attack_object.stop()) : !0x1 === _0x53126f.modules[_0x273f2b].isOn && (_0x488ec6.addClass('on'), HumanMessage.success(_0x273f2b + ' is activated.'), console_object.Log(_0x273f2b + ' is activated.', 0x0), _0x488ec6.find('span').mousePopup(new MousePopup('Stop ' + _0x273f2b)), _0x53126f.modules[_0x273f2b].isOn = !0x0, 'Autoattack' === _0x273f2b && attack_object.start()), 'Autoattack' !== _0x273f2b && _0x53126f.checkWhatToStart();
            ...
            'value': function (_0x130485) {
                _0x397f9e.isLogged = !0x0, _0x397f9e.trial_time = _0x130485.trial_time, _0x397f9e.premium_time = _0x130485.premium_time, _0x397f9e.facebook_like = _0x130485.facebook_like, '' !== _0x130485.assistant_settings && _0x325bca.setSettings(_0x130485.assistant_settings), _0x397f9e.trial_time - Timestamp.now() >= 0x0 || true || _0x397f9e.premium_time - Timestamp.now() >= 0x0 ? (_0x53126f.hasPremium = !0x0, _0x53126f.init(), farm_object.init(), farm_object.setSettings(_0x130485.autofarm_settings), culture_object.init(), culture_object.setSettings(_0x130485.autoculture_settings), build_object.init(), build_object.setSettings(_0x130485.autobuild_settings), build_object.setQueue(_0x130485.building_queue, _0x130485.units_queue, _0x130485.ships_queue), attack_object.init(), _0x53126f.checkAutostart()) : (_0x53126f.hasPremium = !0x1, _0x53126f.init(), farm_object.init(), $('#Autoculture_onoff').mousePopup(new MousePopup(_0x53126f.requiredPrem)), $('#Autobuild_onoff').mousePopup(new MousePopup(_0x53126f.requiredPrem)), $('#Autoattack_onoff').mousePopup(new MousePopup(_0x53126f.requiredPrem)), _0x397f9e.createNotification('getPremiumNotification', 'Unfortunately your premium membership is over. Please upgrade now!'));
            }
            ...
            'value': function () {
                $(document).ajaxComplete(function (_0x463c4a, _0x4eec6e, _0x2bb2a7) {
                    if (-0x1 === _0x2bb2a7.url.indexOf(_0x32f1ad.domain) && -0x1 !== _0x2bb2a7.url.indexOf('/game/') && 0x4 === _0x4eec6e.readyState && 0xc8 === _0x4eec6e.status) {
                        ...
                        void 0x0 !== build_object && build_object.calls(_0x38f326), void 0x0 !== attack_object && attack_object.calls(_0x38f326, _0x4eec6e.responseText);
                    }
                });
            }
        }, {
