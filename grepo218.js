...
var build_object = {
    ...
    callbackSaveBuilding: function(queue_selector) {
        return function(response) {
            queue_selector.each(function() {
                $(this).find(".empty_slot").remove(), 
                response.item ? 
                ($(this).append(build_object.buildingElement($(this), response.item)), 
                build_object.setEmptyItems($(this))) : 
                build_object.setEmptyItems($(this));
            }), delete response.item, build_object.building_queue = response;
        };
    },
