...
var build_object = {
    init: function() {
        ...
        $.Observer(GameEvents.town.town_switch).subscribe('refresh', function() {
            ...
            setTimeout(build_object.updateMainBuildingQueue,800);
        });
        $.Observer(GameEvents.window.building.open).subscribe('senate_open', function() {
            setTimeout(build_object.updateMainBuildingQueue,800);
        });
    },
    setSettings: function(new_settings) {
    ...
    startQueueing: function() {
        ...
        void 0 === build_object.units_queue[build_object.town.id] && 
        void 0 === build_object.ships_queue[build_object.town.id])  
            build_object.finished();
        var _0x13e2c9 = build_object.getReadyTime(build_object.town.id).shouldStart;
        "building" === _0x13e2c9 ? build_object.startBuildBuilding() : 
        "unit" === _0x13e2c9 || "ship" === _0x13e2c9 ? 
        build_object.startBuildUnits("unit" === _0x13e2c9 ? build_object.units_queue : build_object.ships_queue, _0x13e2c9) : 
        build_object.finished();
    },
    ...
    callbackSaveBuilding: function(_0x48518f) {
        return function(_0x4133d6) {
            _0x48518f.each(function() {
                $(this).find(".empty_slot").remove(), _0x4133d6.item ? 
                ($(this).append(build_object.buildingElement($(this), _0x4133d6.item)), build_object.setEmptyItems($(this))) : 
                build_object.setEmptyItems($(this));
            }), delete _0x4133d6.item, build_object.building_queue = _0x4133d6;
        };
    },
    updateMainBuildingQueue: function() {
        var html_queue = $("#building_tasks_main .ui_various_orders, .construction_queue_order_container .ui_various_orders");
        console_object.Log("updateMainBuildingQueue",1);
        html_queue.find(".empty_slot").remove(),
        $.each(build_object.building_queue[Game.townId],function(index,item){
            html_queue.append(build_object.buildingElement(html_queue, item)), 
    ...
    buildingElement: function(building_element_queue, building_element_item) {
        return $("<div/>", {
            ...
            _0xe39ad9.preventDefault(), api_object.Auth("removeItemQueue", {
                ...
                type: "building"
            }, build_object.callbackSaveBuilding($("#building_tasks_main .ui_various_orders, .construction_queue_order_container .ui_various_orders"))), $(".queue_id_" + building_element_item.id).remove();
        }).append($("<div/>", {
            class: "left"
        })).append($("<div/>", {
            class: "right"
    ...
    unitElement: function(unit_element_queue, unit_element_item, _0xed46f8) {
        return $("<div/>", {
            ...
            _0x25fae1.preventDefault(), api_object.Auth("removeItemQueue", {
                ...
                type: _0xed46f8
            }, build_object.callbackSaveUnits($("#unit_orders_queue .ui_various_orders"), _0xed46f8)), $(".queue_id_" + unit_element_item.id).remove();
        }).append($("<div/>", {
            class: "left"
        })).append($("<div/>", {
            class: "right"
