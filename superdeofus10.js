...
!function(m) {
  ...
  var f = function() {
    ...
    return target = that, x = [{
      ...
      value : function() {
        ...
        $.when.apply($, ajaxArr).done(function() {
          ...
          if (0 === that.countRunningAttacks()) {
            ...
            console_object.Log('<span style="color: #ff4f23;">' + feed + "</span>", 4);
            that.disableStart();
          } else {
            /** @type {string} */
          ...
          options.interval = setInterval(function() {
            if (void 0 !== that.attacks[i]) {
              ...
              if (!(300 !== currentEstimate && 120 !== currentEstimate && 60 !== currentEstimate)) {
                console_object.Log('<span style="color: #ff4f23;">[' + that.attacks[i].origin_town_name + " &#62; " + that.attacks[i].target_town_name + "] " + DM.getl10n("heroes").common.departure.toLowerCase().replace(":", "") + " " + DM.getl10n("place").support_overview.just_in + " " + hours_minutes_seconds(currentEstimate) + ".</span>", 4);
              }
      ...
      value : function(_) {
        ...
        if (0 === that.countRunningAttacks()) {
          console_object.Log('<span style="color: #ff4f23;">All finished.</span>', 4);
          that.stop();
        }
      }
    }, {
      ...
      value : function(obj) {
        api_object.send_units(obj.town_id, obj.type, obj.target_town_id, that.unitsToSend(obj.units), function(SMessage) {
          ...
          if (void 0 !== SMessage.success && maints.length) {
            ...
            console_object.Log('<span style="color: #ff9e22;">[' + obj.origin_town_name + " &#62; " + obj.target_town_name + "] " + SMessage.success + "</span>", 4);
          } else {
            if (void 0 !== SMessage.error && maints.length) {
              /** @type {string} */
              maints[0].message_text = "Invalid";
              maints[0].message.html("Invalid");
              console_object.Log('<span style="color: #ff3100;">[' + obj.origin_town_name + " &#62; " + obj.target_town_name + "] " + SMessage.error + "</span>", 4);
            }
          }
        });
      }
  ...
  Object.defineProperty(f, "attacks", {
    enumerable : true,
    writable : true,
    value : []
  });
  Object.defineProperty(f, "attacks_timers", {
    enumerable : true,
    writable : true,
    value : []
  });
  ...
  Object.defineProperty(f, "checked_count", {
    enumerable : true,
    writable : true,
    value : 0
  });
    ...
    return o = self, n = [{
      ...
      value : function(navigatorType) {
        ...
        var init = function() {
          ...
          self.interval = setTimeout(function() {
            console_object.Log(self.town.name + " getting farm information.", 1);
            if (self.isCaptain) {
        ...
        if ($scope.currentTown !== self.town.key) {
          /** @type {number} */
          self.interval = setTimeout(function() {
            console_object.Log(self.town.name + " move to town.", 1);
      ...
      value : function() {
        if (!self.town.farmTowns[0]) {
          return console_object.Log(self.town.name + " has no farm towns.", 1), self.finished(1800), false;
        }
        if (self.town.currentFarmCount < self.shouldFarm.length) {
          ...
          if (self.shouldFarm.length > 0) {
            ...
            console_object.Log(self.town.name + " not ready yet.", 1);
          }
      ...
      value : function(extension, request) {
        if (request.success) {
          ...
          console_object.Log('<span style="color: #6FAE30;">' + request.success + "</span>", 1);
        } else {
          if (request.error) {
            console_object.Log(self.town.name + " " + request.error, 1);
          }
        }
      }
    }, {
      ...
      value : function(that) {
        if (that.success) {
          ...
          console_object.Log('<span style="color: #6FAE30;">' + that.success + "</span>", 1);
        } else {
          if (that.error) {
            console_object.Log(self.town.name + " " + that.error, 1);
          }
        }
      }
    }, {
  ...
  Object.defineProperty(owner, "settings", {
    enumerable : true,
    writable : true,
    value : {
      autostart : false,
  ...
  Object.defineProperty(owner, "title", {
    enumerable : true,
    writable : true,
    value : "Autofarm settings"
  });
  Object.defineProperty(owner, "town", {
    enumerable : true,
    writable : true,
    value : null
  });
  Object.defineProperty(owner, "isPauzed", {
    enumerable : true,
    writable : true,
    value : false
  });
  Object.defineProperty(owner, "iTown", {
    enumerable : true,
    writable : true,
    value : null
  });
  Object.defineProperty(owner, "interval", {
    enumerable : true,
    writable : true,
    value : null
  });
  Object.defineProperty(owner, "isCaptain", {
    enumerable : true,
    writable : true,
    value : false
  });
  Object.defineProperty(owner, "shouldFarm", {
    enumerable : true,
    writable : true,
    value : []
  });
  ...
  var host = function() {
    ...
    return Constructor = self, staticProps = [{
      key : "init",
      value : function() {
        console_object.Log("Initialize Autoculture", 2);
        self.initButton();
      }
    }, {
      key : "initButton",
      ...
      key : "startCulture",
      value : function(navigatorType) {
        return !!self.checkEnabled() && ($scope.modules.Autoculture.isOn ? (self.town = navigatorType, self.iTown = ITowns.towns[self.town.id], void($scope.currentTown !== self.town.key ? (console_object.Log(self.town.name + " move to town.", 2), api_object.switch_town(self.town.id, function() {
          if (!self.checkEnabled()) {
            return false;
          }
          $scope.currentTown = self.town.key;
      ...
      value : function() {
        ...
        self.interval = setTimeout(function() {
          if (void 0 !== self.settings.towns[self.town.id]) {
            console_object.Log(self.town.name + " getting event information.", 2);
            api_object.building_place(self.town.id, function(res) {
              ...
              !function start(oStartData) {
                if (3 === i) {
                  return _0x112f0d || console_object.Log(self.town.name + " not ready yet.", 2), self.finished(elapsed), false;
                }
        ...
        api_object.start_celebration(self.town.id, method.name, function(res) {
          ...
          if (void 0 === res.json.error) {
            ...
            if (void 0 !== _0x3196b3.Celebration) {
              console_object.Log('<span style="color: #fff;">' + PopupFactory.texts[_0x3196b3.Celebration.celebration_type] + " is started.</span>", 2);
              /** @type {number} */
              toFloat = _0x3196b3.Celebration.finished_at - Timestamp.now();
            }
          } else {
            console_object.Log(self.town.name + " " + res.json.error, 2);
          }
          func(toFloat);
        });
      }
      ...
      key : "callbackSave",
      value : function() {
        console_object.Log("Settings saved", 2);
        HumanMessage.success("The settings were saved!");
      }
  ...
  Object.defineProperty(host, "town", {
    enumerable : true,
    writable : true,
    value : null
  });
  Object.defineProperty(host, "iTown", {
    enumerable : true,
    writable : true,
    value : null
  });
  Object.defineProperty(host, "interval", {
    enumerable : true,
    writable : true,
    value : null
  });
  Object.defineProperty(host, "isStopped", {
    enumerable : true,
    writable : true,
    value : false
  });
  ...
  var obj = function() {
    ...
    return t = self, n = [{
      ...
      value : function(navigatorType) {
        ...
        self.iTown = ITowns.towns[self.town.id];
        if ($scope.currentTown !== self.town.key) {
          console_object.Log(self.town.name + " move to town.", 3);
          api_object.switch_town(self.town.id, function() {
            $scope.currentTown = self.town.key;
            self.startUpgrade();
          });
          ...
          self.interval = setTimeout(function() {
            api_object.frontend_bridge(self.town.id, {
              ...
              if (SMessage.success) {
                ...
                console_object.Log('<span style="color: #ffa03d;">' + self.instantBuyTown.building_name.capitalize() + " - " + SMessage.success + "</span>", 3);
              }
              if (SMessage.error) {
                console_object.Log(self.town.name + " " + SMessage.error, 3);
              }
              /** @type {number} */
              self.interval = setTimeout(function() {
                /** @type {boolean} */
        ...
        if (void 0 !== obj2[self.town.id]) {
          if (void 0 !== obj2[self.town.id]) {
            ...
            if (GameDataUnits.getMaxBuildForSingleUnit(item.item_name) >= item.count) {
              ...
              self.interval = setTimeout(function() {
                api_object.building_barracks(self.town.id, {
                  ...
                  if (replacementInfo.error) {
                    console_object.Log(self.town.name + " " + replacementInfo.error, 3);
                  } else {
                    if (self.town.id === Game.townId) {
                      var matchers = GPWindowMgr.getByType(GPWindowMgr.TYPE_BUILDING);
                      /** @type {number} */
                    ...
                    console_object.Log('<span style="color: ' + ("unit" === field ? "#ffe03d" : "#3dadff") + ';">Units - ' + item.count + " " + GameData.units[item.item_name].name_plural + " added.</span>", 3);
              ...
              console_object.Log(self.town.name + " recruiting " + item.count + " " + GameData.units[item.item_name].name_plural + " not ready.", 3);
              self.finished();
            }
          } else {
            self.finished();
      ...
      value : function() {
        ...
        if (void 0 !== self.building_queue[self.town.id] && self.building_queue[self.town.id]) {
          /** @type {number} */
          self.interval = setTimeout(function() {
            console_object.Log(self.town.name + " getting building information.", 3);
            api_object.building_main(self.town.id, function(init) {
              if (self.hasFreeBuildingSlots(init)) {
                  ...
                  if (_0x40d77e.can_upgrade) {
                    api_object.frontend_bridge(self.town.id, {
                      ...
                      if (SMessage.success) {
                        ...
                        console_object.Log('<span style="color: #ffa03d;">' + o.item_name.capitalize() + " - " + SMessage.success + "</span>", 3);
                        api_object.Auth("removeItemQueue", {
                          player_id : settings.Account.player_id,
                          world_id : settings.Account.world_id,
                          csrfToken : settings.Account.csrfToken,
                    ...
                    if (_0x40d77e.enough_population) {
                      if (_0x40d77e.enough_resources) {
                        console_object.Log(self.town.name + " " + o.item_name + " can not be started due dependencies.", 3);
                        api_object.Auth("removeItemQueue", {
                          player_id : settings.Account.player_id,
                          world_id : settings.Account.world_id,
                          csrfToken : settings.Account.csrfToken,
                        ...
                        console_object.Log(self.town.name + " not enough resources for " + o.item_name + ".", 3);
                        self.finished();
                      }
                    } else {
                      console_object.Log(self.town.name + " not enough population for " + o.item_name + ".", 3);
                      self.finished();
                    }
                  }
                } else {
                ...
                console_object.Log(self.town.name + " no free building slots available.", 3);
                self.finished();
              }
            });
          }, settings.randomize(1e3, 2e3));
  ...
  Object.defineProperty(obj, "building_queue", {
    enumerable : true,
    writable : true,
    value : {}
  });
  Object.defineProperty(obj, "units_queue", {
    enumerable : true,
    writable : true,
    value : {}
  });
  Object.defineProperty(obj, "ships_queue", {
    enumerable : true,
    writable : true,
    value : {}
  });
  Object.defineProperty(obj, "town", {
    enumerable : true,
    writable : true,
    value : null
  });
  Object.defineProperty(obj, "iTown", {
    enumerable : true,
    writable : true,
    value : null
  });
  ...
  Object.defineProperty(obj, "currentWindow", {
    enumerable : true,
    writable : true,
    value : null
  });
  Object.defineProperty(obj, "isCaptain", {
    enumerable : true,
    writable : true,
    value : false
  });
  ...
  Object.defineProperty(obj, "ModuleManager", {
    enumerable : true,
    writable : true,
    value : void 0
  });
  Object.defineProperty(obj, "windows", {
    enumerable : true,
    writable : true,
    value : {
      wndId : null,
    ...
    return o = self, to = [{
      ...
      value : function() {
        ...
        if ($.each(self.playerTowns, function(canCreateDiscussions, id) {
          ...
          console_object.Log("Nothing is ready yet!", 0);
      ...
      value : function(name) {
        ...
        $item.on("click", function(event) {
          ...
          if (true === self.modules[name].isOn) {
            ...
            console_object.Log(name + " is deactivated.", 0);
            if ("Autofarm" === name) {
              that.stop();
            } else {
              if ("Autoculture" === name) {
            ...
            if (false === self.modules[name].isOn) {
              ...
              console_object.Log(name + " is activated.", 0);
      ...
      value : function(data) {
        ...
        if (settings.trial_time - Timestamp.now() >= 0 || settings.premium_time - Timestamp.now() >= 0) {
          /** @type {boolean} */
  ...
  Object.defineProperty(me, "models", {
    enumerable : true,
    writable : true,
    value : {
      Town : function() {
  ...
  Object.defineProperty(me, "Queue", {
    enumerable : true,
    writable : true,
    value : {
      total : 0,
  ...
  Object.defineProperty(me, "currentTown", {
    enumerable : true,
    writable : true,
    value : null
  });
  Object.defineProperty(me, "playerTowns", {
    enumerable : true,
    writable : true,
    value : []
  });
  ...
  Object.defineProperty(me, "hasPremium", {
    enumerable : true,
    writable : true,
    value : false
  });
  Object.defineProperty(me, "modules", {
    enumerable : true,
    writable : true,
    value : {
      Autofarm : {
  ...
  Object.defineProperty(me, "requiredPrem", {
    enumerable : true,
    writable : true,
  ...
  Object.defineProperty(self, "domain", {
    enumerable : true,
    writable : true,
    value : "https://bot.grepobot.com/"
  });
  Object.defineProperty(self, "botWnd", {
    enumerable : true,
    writable : true,
    value : ""
  });
  Object.defineProperty(self, "botPremWnd", {
    enumerable : true,
    writable : true,
    value : ""
  });
  Object.defineProperty(self, "botEmailWnd", {
    enumerable : true,
    writable : true,
    value : ""
  });
  Object.defineProperty(self, "facebookWnd", {
    enumerable : true,
    writable : true,
    value : ""
  });
  Object.defineProperty(self, "isLogged", {
    enumerable : true,
    writable : true,
    value : false
  });
