! function(function_list) {
    ...
    if (dictionary[0]) return dictionary[0].exports;
    var _0x22f4d7 = dictionary[0] = {
        i: 0,
        l: false,
        exports: {}
    };
    return function_list[0].call(_0x22f4d7.exports, _0x22f4d7, _0x22f4d7.exports, _0x16f3a2), _0x22f4d7.l = true, _0x22f4d7.exports;
    ...
    var api_object =  {
        ...
        , 
            PaymentOptions: function(callback) {
                $.ajax({
                    method: "GET",
        ...
        , 
            claim_loads: function(_0x51167d, _0x47a6bb, _0xf97aaf, _0x5c76b5, _0xa902af) {
                ...
                _0x584a6f = {
                    ...
                    method: "POST",
                    dataType: "json",
                    success: api_object.default_handler(_0xa902af)
                });
            }
        , 
            building_place: function(_0x1a2bc9, _0x25dab0) {
                ...
                _0x23be9d = {
                    ...
                    method: "GET",
                    dataType: "json",
                    success: api_object.default_handler(_0x25dab0, true)
                });
            }
        , 
            building_main: function(_0x22b5ac, _0x2eed12) {
                ...
                _0x4f59d5 = {
                    ...
                    method: "GET",
                    dataType: "json",
                    success: api_object.default_handler(_0x2eed12)
                });
            }
        , 
            start_celebration: function(_0xc7df6f, _0x2393a3, _0x1003a9) {
                ...
                _0x46ad5b = {
                    ...
                    method: "POST",
                    dataType: "json",
                    success: api_object.default_handler(_0x1003a9, true)
                });
            }
        , 
            email_validation: function(_0x4450db) {
                var _0x4e002e = {
                        town_id: Game.townId,
                ...
                $.ajax({
                    ...
                    method: "GET",
                    dataType: "json",
                    success: api_object.default_handler(_0x4450db, true)
                });
            }
        , 
            members_show: function(_0x464075) {
                var _0x3a1d0e = {
                        town_id: Game.townId,
                        action: "members_show",
                        h: Game.csrfToken,
                ...
                $.ajax({
                    ...
                    method: "GET",
                    dataType: "json",
                    success: api_object.default_handler(_0x464075)
                });
            }
        , 
            login_to_game_world: function(_0x242393) {
        ...
        , 
            frontend_bridge: function(_0x173ff1, _0x150788, _0x563751) {
                ...
                $.ajax({
                    ...
                    method: "POST",
                    dataType: "json",
                    success: api_object.default_handler(_0x563751)
                });
            }
        , 
            building_barracks: function(_0x455bf8, _0x992d22, _0x59a081) {
                ...
                $.ajax({
                    ...
                    method: "POST",
                    dataType: "json",
                    success: api_object.default_handler(_0x59a081)
                });
            }
        , 
            attack_planner: function(_0x1498d1, _0x458bc2) {
                ...
                _0x885ca8 = {
                    ...
                    method: "GET",
                    dataType: "json",
                    success: api_object.default_handler(_0x458bc2)
                });
            }
        , 
            town_info_attack: function(_0xf90471, _0x24e029, _0x2105f5) {
                ...
                _0x4ed5f7 = {
                    ...
                    method: "GET",
                    dataType: "json",
                    success: api_object.default_handler(_0x2105f5)
                });
            }
        ,
            send_units: function(_0x54e6aa, _0x4f54e9, _0x18bc40, _0x4cf475, _0x5b49b8) {
                ...
                $.ajax({
                    ...
                    method: "POST",
                    dataType: "json",
                    success: api_object.default_handler(_0x5b49b8)
                });
            }
    };
    ...
    var main_object = {
        ...
        start: function() {
            ...
            if ($.each(main_object.playerTowns, function(index, town) {
                    ...
                    true === ready ? (flag = true, main_object.Queue.add({
                        townId: town.id,
                        fx: function() {
                            town.startFarming();
                        }
                    })) : false !== ready && (null == _0x2ca9c8 || ready < _0x2ca9c8) && (_0x2ca9c8 = ready);
                    var _0x39d13c = culture_object.checkReady(town);
                    true === _0x39d13c ? (flag = true, main_object.Queue.add({
                        townId: town.id,
                        fx: function() {
                            town.startCulture();
                        }
                    ...
                    true === _0x2c7ceb ? (flag = true, main_object.Queue.add({
                        townId: town.id,
                        fx: function() {
                            town.startBuild();
                        }
                ...
                if (flag) main_object.Queue.start();
                else {
        ...
        Queue: {
            ...
            next: function() {
                ...
                element ? element.fx() : this.queue.length <= 0 && (this.total = 0, main_object.finished());
            }
        },
        currentTown: null,
        playerTowns: [],
        ...
        init: function() {
            ...
            initWnd: function() {
                if (autobot_object.isLogged) {
                    ...
                    autobot_object.botWnd = Layout.dialogWindow.open("", autobot_object.title + ' v<span style="font-size: 10px;">' + autobot_object.version + "</span>", 500, 350, "", false), autobot_object.botWnd.setHeight([350]), autobot_object.botWnd.setPosition(["center", "center"]);
                    var _0x1af1f8 = autobot_object.botWnd.getJQElement();
                    _0x1af1f8.append($("<div/>", {
                        class: "menu_wrapper",
                        style: "left: 78px; right: 14px"
                    }).append($("<ul/>", {
                        class: "menu_inner"
                    }).prepend(autobot_object.addMenuItem("AUTHORIZE", "Account", "Account")).prepend(autobot_object.addMenuItem("CONSOLE", "Assistant", "Assistant")).prepend(autobot_object.addMenuItem("ASSISTANT", "Console", "Console")).prepend(autobot_object.addMenuItem("SUPPORT", "Support", "Support")))), _0x1af1f8.find(".menu_inner li:last-child").before(autobot_object.addMenuItem("ATTACKMODULE", "Attack", "Autoattack")), _0x1af1f8.find(".menu_inner li:last-child").before(autobot_object.addMenuItem("CONSTRUCTMODULE", "Build", "Autobuild")), _0x1af1f8.find(".menu_inner li:last-child").before(autobot_object.addMenuItem("CULTUREMODULE", "Culture", "Autoculture")), _0x1af1f8.find(".menu_inner li:last-child").before(autobot_object.addMenuItem("FARMMODULE", "Farm", "Autofarm")), $("#Autobot-AUTHORIZE").click();
                }
            }, 
            addMenuItem: function(_0x52f45d, _0x3a8959, _0x4e64a4, _0x26e24f) {
                return $("<li/>").append($("<a/>", {
                    class: "submenu_link",
                    href: "#",
                    ...
                    if (autobot_object.botWnd.getJQElement().find("li a.submenu_link").removeClass("active"), $(this).addClass("active"), autobot_object.botWnd.setContent2(autobot_object.getContent($(this).attr("rel"))), "Console" === $(this).attr("rel")) {
                ...
                var data = {
                    ...
                    table_content = $("<table/>", {
                        ...
                        return $.each(data, function(key, value) {
                            ...
                            return 0 === autobot_object.facebook_like ? $("<a/>", {
                                id: "get_7days"
                            }).html("Get 3 free days!").click("on", function() {
                                return autobot_object.botFacebookWnd();
                            }) : null;
                        }))), body;
                    });
            ...
            getPremium: function() {
                ...
                if (autobot_object.isLogged) {
                    ...
                    autobot_object.botPremWnd = Layout.dialogWindow.open("", "Autobot v" + autobot_object.version + " - Premium", 500, 350, "", false), autobot_object.botPremWnd.setHeight([350]), autobot_object.botPremWnd.setPosition(["center", "center"]);
                    var _0x1fc633 = $("<div/>", {
                        id: "payment"
                    }).append($("<div/>", {
                        id: "left"
                    ...
                    autobot_object.botPremWnd.setContent2(_0x1fc633), $("#time_options li").on("click", function() {
            ...
            makeSelectbox: function(_0x1ace7d) {
                var _0x1dc3ef = {},
                    _0x30eea8 = $("<select/>", {
                        id: "paymentSelect"
                    }).append(function() {
                ...
                _0x5a2cf8.text(_0x4865aa.children("option").eq(0).text()), $("#payment #information").append(function() {
                    ...
                    return $("<div/>", {
                        ...
                        return autobot_object.doPayment($("#time_options").children(".active").index() + 1, _0x478ff1);
                    });
                });
                ...
                _0x5a2cf8.click(function(_0x379d64) {
                    ...
                    _0x1db48f.stopPropagation(), $("#payment-button").remove(), _0x5a2cf8.text($(this).text()).removeClass("active"), $("#payment #information").append($("<div/>", {
                        ...
                        return autobot_object.doPayment($("#time_options").children(".active").index() + 1, $(_0x4d73cf).attr("rel"));
                    })), _0x4865aa.val($(this).attr("rel")), _0x250f4c.hide();
                }), $(document).click(function() {
                    _0x5a2cf8.removeClass("active"), _0x250f4c.hide();
                });
            }, 
            doPayment: function(_0xd89db7, _0x1fca1b) {
                window.open(autobot_object.domain + "payment?option=" + _0xd89db7 + "&method=" + _0x1fca1b + "&player_id=" + autobot_object.Account.player_id, "grepolis_payment", "directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,height=650,width=800");
            }, 
            ...
            randomize: function(_0x253e60, _0x457001) {
                return Math.floor(Math.random() * (_0x457001 - _0x253e60 + 1)) + _0x253e60;
            }, 
            secondsToTime: function(_0x470d8a) {
            ...
            timeToSeconds: function(_0x4c41ad) {
