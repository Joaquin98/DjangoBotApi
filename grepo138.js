...
var build_object = {
    init: function() {
        ...
        $.Observer(GameEvents.town.town_switch).subscribe('refresh', function() {
            ...
            setTimeout(function(){build_object.initQueue($("#unit_orders_queue .ui_various_orders"), "unit");},200);
    ...
    initFunction: function() {
        ...
        /** Supuestamente agrega a la funcion que hace render de las colas para que agregue los pedidos extra */
        GameViews.ConstructionQueueBaseView.prototype.renderQueue = function() {
            GameViews.ConstructionQueueBaseView.prototype.renderQueue.apply(this, arguments), 
        ...
        UnitOrder.selectUnit = function() {
                UnitOrder.selectUnit.apply(this, arguments);
                if (this.barracks) 
    ...
    checkReady: function(_0xba3b92) {
        ...
        !_0x4d7162.hasConqueror() && !!(build_object.settings.enable_building || 
            build_object.settings.enable_units || build_object.settings.enable_ships) && 
            (_0xba3b92.modules.Autobuild.isReadyTime >= Timestamp.now() ? _0xba3b92.modules.Autobuild.isReadyTime : 
            !(void 0 === build_object.building_queue[_0xba3b92.id] && void 0 === build_object.units_queue[_0xba3b92.id] && 
                void 0 === build_object.ships_queue[_0xba3b92.id]));
    },
