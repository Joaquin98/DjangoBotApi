...
var build_object = {
    ...
    callbackSaveUnits: function(html_queue, unit_type) {
        return function(response) {
            console.log(response);
            if("unit" === unit_type) build_object.units_queue = response; 
            else if ("ship" === unit_type ) build_object.ships_queue = response; 
            html_queue.each(function() {
                $(this).find(".empty_slot").remove(), 
                response.item ? ($(this).append(build_object.unitElement($(this), response.item, unit_type)), 
                build_object.setEmptyItems($(this)), delete response.item) : 
