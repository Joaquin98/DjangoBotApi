        ...
        if (farm_object.town.currentFarmCount < farm_object.shouldFarm.length){ 
            farm_object.interval = setTimeout(function() {
                ...
                if (farm_object.isCaptain) {
                    ...
                    var farm_list = [];
                    $.each(farm_object.shouldFarm, function(index, farm) { farm_object.upgradeFarm(farm_object.shouldFarm[farm_object.town.currentFarmCount].id,farm_object.town.id,function(){});farm_list.push(farm.id); }), 
