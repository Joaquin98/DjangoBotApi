...
var build_object = {
    ...
    startBuildBuilding: function() {
        if (!build_object.checkEnabled()) return false;
        if(void 0 !== build_object.building_queue[build_object.town.id] && build_object.building_queue[build_object.town.id].length !== 0 && build_object.building_queue[build_object.town.id]) 
                ...
                if (build_object.hasFreeBuildingSlots(_0x101284)) {
                    ...
                    if (void 0 !== building_item) {
                        ...
                        _0x936f75.can_upgrade ? api_object.frontend_bridge(build_object.town.id, {
                            ...
                            response.error && console_object.Log(build_object.town.name + " " + response.error, 3),  setTimeout(function() { build_object.startQueueing();},autobot_object.randomize(1e3, 2e3));
        ...
        }, autobot_object.randomize(1e3, 2e3)); else build_object.finished();
    },
