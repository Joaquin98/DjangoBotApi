...
var build_object = {
    ...
    startBuildBuilding: function() {
        if (!build_object.checkEnabled()) return false;
        void 0 !== build_object.building_queue[build_object.town.id] && build_object.building_queue[build_object.town.id].length !== 0 ? build_object.interval = setTimeout(function() {
