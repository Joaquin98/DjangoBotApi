...
var build_object = {
    init: function() {
        ...
        $.Observer(GameEvents.town.town_switch).subscribe('refresh', function() {
            ...
            setTimeout(function(){build_object.initQueue($(".construction_queue_order_container"), "unit");},200);
    ...
    initFunction: function() {
        var render_queue = render_queue = GameViews.ConstructionQueueBaseView.prototype.renderQueue;
        console_object.Log("Se Ejecuta la initFunction", 1);
        GameViews.ConstructionQueueBaseView.prototype.renderQueue = function() {
            render_queue.apply(this, arguments), 
            "#building_tasks_main .various_orders_queue .frame-content .various_orders_content" !== this.$el.selector && 
            "#ui_box .ui_construction_queue .construction_queue_order_container" !== this.$el.selector || 
            build_object.initQueue(this.$el, "building");
            if ("#unit_orders_queue .js-researches-queue" === this.$el.selector) {
        ...
        UnitOrder.selectUnit = function(_0x552d2a) {    
            return function() {
                _0x552d2a.apply(this, arguments);
                if (this.barracks) 
                    build_object.initUnitOrder(this, "unit") 
                else
                 this.barracks || build_object.initUnitOrder(this, "ship");
            };
