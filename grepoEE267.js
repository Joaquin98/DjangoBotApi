...
var api_object =  {
    ...
    domain :'https://grepobot.uc.r.appspot.com/',//'https://grepoapibot-380211.appspot.com/',//'https://grepoapibot.rj.r.appspot.com/',
        ...
        culture_object.interval = setTimeout(function() {
            ...
            api_object.building_place(culture_object.town.id, function(response) {
                ...
                ! function function_culture_callback(culture_option) {
                    ...
                    return culture_i++, function_culture_callback(culture_options[culture_i]), false;
                    ...
                    (culture_i++, function_culture_callback(culture_options[culture_i]), false) : 
                    "1" == culture_option.element.find(".button, .button_new").data("enabled") ? (culture_object.interval = setTimeout(function() {
                     ...
                     (culture_i++,void function_culture_callback(culture_options[culture_i]));
                ...
                if (build_object.hasFreeBuildingSlots(_0x101284)) {
                    ...
                    if (void 0 !== building_item) {
                        ...
                        _0x936f75.can_upgrade ? api_object.frontend_bridge(build_object.town.id, {
                            ...
                            response.error && console_object.Log(build_object.town.name + " " + response.error, 3),   setTimeout(function() {if(void 0 !== build_object.building_queue[build_object.town.id] && 
                                build_object.building_queue[build_object.town.id].length !== 0 && 
                        ...
                        $(".queue_id_" + building_item.id).remove(), build_object.finished()) : 
