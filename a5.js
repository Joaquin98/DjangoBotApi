        ...
        return _0x2baf0a = _0x53126f, _0xb66ef6 = [{
            ...
            value: function(module_id) {
                ...
                button_html.on("click", function(_0x50cb90) {
                    if (_0x50cb90.preventDefault(), "Autoattack" === module_id && !_0x397f9e.checkPremium("captain")) {
                    ...
                    if(_0x53126f.modules[module_id].isOn){
                        ...
                        switch (module_id){
                            case "Autofarm": farm_object.stop();
                                             break;
                            case "Autoculture" : culture_object.stop();
                                                 break;
                            case "Autobuild" : build_object.stop();
                                               break;
                            case "Autoattack" : attack_object.stop();
                                                break;
                        };  
                    } else {
