...
var build_object = {
    init: function() {
        ...
        $.Observer(GameEvents.town.town_switch).subscribe('refresh', function() {
            ...
            setTimeout(build_object.updateQueues,200);
        });
    },
    setSettings: function(new_settings) {
    ...
    updateQueue: function() {
        ...
        console_object.Log("updateQueue",1);
        html_queue.each(function(index, queue) {
                $(this).find(".empty_slot").remove(),
                $.each(build_object.building_queue,function(index,item){
                    $(this).append(build_object.buildingElement($(this), item.item)), 
                    build_object.setEmptyItems($(this));
                });
            });
    },
