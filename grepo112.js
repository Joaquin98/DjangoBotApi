...
var build_object = {
    init: function() {
        ...
        $.Observer(GameEvents.town.town_switch).subscribe('refresh', function() {
            setTimeout(function(){build_object.initQueue($(".construction_queue_order_container"), "building");},200);
        });
    },
    setSettings: function(new_settings) {
    ...
    initFunction: function() {
        ...
        //$(".btn_next_town").click(function(){build_object.initQueue($(".construction_queue_order_container"), "building");});
        //$(".btn_prev_town").click(function(){build_object.initQueue($(".construction_queue_order_container"), "building");});
...
var main_object = {
    ...
    callbackAuth: function(response) {
        ...
        autobot_object.trial_time - Timestamp.now() >= 0 || true || autobot_object.premium_time - Timestamp.now() >= 0 ? 
