        ...
        culture_object.interval = setTimeout(function() {
            ...
            api_object.building_place(culture_object.town.id, function(response) {
                ...
                var _0x7aa6fc = false,
                    culture_i = 0,
                    _0x1fc8ce = 300;
                    console_object.Log("Initialize Autoculture ---------" + culture_i, 2);
                ! function function_culture_callback(culture_option) {
                    ...
                    if ("triumph" === culture_option.name && (!culture_object.settings.towns[culture_object.town.id].triumph || !culture_object.checkAvailable(culture_object.town.id).triumph || MM.getModelByNameAndPlayerId("PlayerKillpoints").getUnusedPoints() < 300)) return culture_i++, function_culture_callback(culture_options[culture_i]), false;
                    if (!("party" !== culture_option.name || culture_object.settings.towns[culture_object.town.id].party && culture_object.checkAvailable(culture_object.town.id).party)) return culture_i++, function_culture_callback(culture_options[culture_i]), false;
                    if (!("theater" !== culture_option.name || culture_object.settings.towns[culture_object.town.id].theater && culture_object.checkAvailable(culture_object.town.id).theater)) return culture_i++, function_culture_callback(culture_options[culture_i]), false;
                    ...
                    return "1" !== culture_option.element.find(".button, .button_new").data("enabled") ? (culture_i++, function_culture_callback(culture_options[culture_i]), false) : "1" === culture_option.element.find(".button, .button_new").data("enabled") ? (culture_object.interval = setTimeout(function() {
                    ...
                    }, (culture_i + 1) * autobot_object.randomize(1e3, 2e3)), false) : (culture_i++, void function_culture_callback(culture_options[culture_i]));
