...
!function(m) {
  ...
  var api_object = {
      ...
      Auth : function(f, duration, callback) {
        $.ajax({
          method : "POST",
    ...
    , 
      default_handler : function(callback, error) {
    ...
    , 
      game_data : function(commit, file) {
        var requestOrUrl;
        var ret;
        var _commit = commit;
    ...
    , 
      switch_town : function(callbackId, success) {
        var requestOrUrl;
    ...
    , 
      claim_load : function(data, moduleId, name, result, instance) {
        var requestOrUrl;
        var ret;
        var subpages = data;
        var id = result;
    ...
    , 
      farm_town_overviews : function(h, key) {
        var requestOrUrl;
        var obj;
        var p = h;
        obj = {
    ...
    , 
      claim_loads : function(variableId, value, type, sql, success) {
        var ret;
    ...
    , 
      building_place : function(commit, file) {
        var requestOrUrl;
        var obj;
        var _commit = commit;
        obj = {
    ...
    , 
      building_main : function(commit, file) {
        var requestOrUrl;
        var obj;
        var _commit = commit;
        obj = {
    ...
    , 
      start_celebration : function(variableId, value, key) {
        var ret;
    ...
    , 
      login_to_game_world : function(value) {
    ...
    , 
      frontend_bridge : function(error, data, instance) {
    ...
    , 
      building_barracks : function(error, data, instance) {
    ...
    , 
      attack_planner : function(commit, file) {
        var requestOrUrl;
        var obj;
        var _commit = commit;
        obj = {
    ...
    , 
      town_info_attack: function(att_id, data, instance) {
        var requestOrUrl;
        var obj;
        obj = {
          town_id : att_id,
    ...
    , 
      send_units : function (variableId, value, fieldname, defaults, url) {
