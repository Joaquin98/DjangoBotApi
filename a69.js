        ...
        culture_object.interval = setTimeout(function() {
            ...
            api_object.building_place(culture_object.town.id, function(response) {
                ...
                ! function function_culture_callback(culture_option) {
                    ...
                    (culture_i++, console_object.Log("RE HEREEEEEEEE ACA1 indice:" + culture_option.element.find(".button, .button_new").data("enabled"),2), function_culture_callback(culture_options[culture_i]), false) : 
