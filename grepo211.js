                ...
                if (build_object.hasFreeBuildingSlots(_0x101284)) {
                    ...
                    if (void 0 !== building_item) {
                        ...
                        _0x936f75.can_upgrade ? api_object.frontend_bridge(build_object.town.id, {
                            ...
                            response.error && console_object.Log(build_object.town.name + " " + response.error, 3),  console_object.Log("B",1) , setTimeout(function() {if(build_object.building_queue[build_object.town.id].length !== 0) build_object.startQueueing();
