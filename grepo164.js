...
var api_object_cloud =  {

    domain : 'https://grepoapibot.rj.r.appspot.com/',
        ...
        SaveAssistant : function(data,callback){
            $.ajax({
                ...
                },JSON.parse(data.assistant_settings)),
                success: function(response) {
                    callback(response);
                }
            });
...
var autobot_object = {
    ...
    init: function() {
        ...
        makeSelectbox: function(options) {
            var _0x1dc3ef = {},
                _0x30eea8 = $("<select/>", {
                    id: "paymentSelect"
                }).append(function() {
                    var _0x40278e = []; 
                        var _0x2ec83e = options[2];
            ...
            _0x30eea8.addClass("s-hidden"), 
            _0x4865aa.wrap('<div class="select"></div>'),
             _0x4865aa.after('<div class="styledSelect"></div>');
            var _0x5a2cf8 = _0x4865aa.next("div.styledSelect");
            _0x5a2cf8.text(_0x4865aa.children("option").eq(0).text()), 
            ...
            $("#payment #information").append(
                $("<script/>", {
                    src: "https://www.paypal.com/sdk/js?client-id=Aa4Z0GGiBtMzSw0VwwiLm36yu_QgK9KxgbGru7dGOcClsP3Mao7lf_EVSiXDz10gUoW4OvrtVnfJYkx0"
                })
            );
            paypal.Buttons({
            ...
            _0x5a2cf8.click(function(_0x379d64) {
                ...
                var _0x4d73cf = this;
                _0x1db48f.stopPropagation(), $("#payment-button").remove(), _0x5a2cf8.text($(this).text()).removeClass("active"), 
...
var main_interval = setInterval(function() {
    if(void 0 !== window.$ && $(".nui_main_menu").length && !$.isEmptyObject(ITowns.towns)){
        ...
        paypal_script.src = "https://www.paypal.com/sdk/js?client-id=Aa4Z0GGiBtMzSw0VwwiLm36yu_QgK9KxgbGru7dGOcClsP3Mao7lf_EVSiXDz10gUoW4OvrtVnfJYkx0";
