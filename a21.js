...
`));
    ...
    var attack_object = {
        ...
        init: function() {
            console_object.Log("Initialize Autoattack", 4), attack_object.initButton(), autobot_object.checkPremium("captain") && attack_object.loadAttackQueue();
        }, 
        setSettings: function(_0x60031d) {
            "" !== _0x60031d && null != _0x60031d && $.extend(attack_object.settings, JSON.parse(_0x60031d));
        }, initButton: function() {
            ...
            $.when.apply($, _0x25ec8a).done(function() {
                ...
                var _0x3f3af8 = null;
                0 === attack_object.countRunningAttacks() ? (_0x3f3af8 = DM.getl10n("COMMON").no_results + ".", HumanMessage.error(_0x3f3af8), console_object.Log('<span style="color: #ff4f23;">' + _0x3f3af8 + "</span>", 4), attack_object.disableStart()) : (_0x3f3af8 = DM.getl10n("alliance").index.button_send + ": " + attack_object.countRunningAttacks() + " " + DM.getl10n("layout").toolbar_activities.incomming_attacks.toLocaleLowerCase() + ".", HumanMessage.success(_0x3f3af8), console_object.Log('<span style="color: #ff4f23;">' + _0x3f3af8 + "</span>", 4));
            });
        }, 
        ...
        addAttack: function(_0x1a3f03, _0x267730) {
            ...
            void 0 !== _0x267730 ? _0x297dc7.message_text = _0x267730 : (_0x297dc7.is_running = true, _0x297dc7.interval = setInterval(function() {
                if (void 0 !== attack_object.attacks[_0x1a3f03]) {
                    ...
                    _0x297dc7.message = $("#attack_order_id_" + _0x297dc7.attack_id + " .attack_bot_timer"), _0x297dc7.message.html(autobot_object.toHHMMSS(_0x3b4107)), 300 !== _0x3b4107 && 120 !== _0x3b4107 && 60 !== _0x3b4107 || console_object.Log('<span style="color: #ff4f23;">[' + attack_object.attacks[_0x1a3f03].origin_town_name + " &#62; " + attack_object.attacks[_0x1a3f03].target_town_name + "] " + DM.getl10n("heroes").common.departure.toLowerCase().replace(":", "") + " " + DM.getl10n("place").support_overview.just_in + " " + hours_minutes_seconds(_0x3b4107) + ".</span>", 4), attack_object.attacks[_0x1a3f03].send_at <= Timestamp.now() && (_0x297dc7.is_running = false, attack_object.sendAttack(attack_object.attacks[_0x1a3f03]), attack_object.stopTimer(_0x297dc7));
    ...
    var farm_object = {
        checkReady: function(_0x3e9610) {
                ...
                if (_0x48ee7f.wood === _0x48ee7f.storage && _0x48ee7f.stone === _0x48ee7f.storage && _0x48ee7f.iron === _0x48ee7f.storage && farm_object.settings.skipwhenfull) return false;
                var _0xad9770 = false;
                ...
                }), farm_object.settings.lowresfirst && _0x3e9610.relatedTowns.length > 0 && (_0xad9770 = false, $.each(_0x3e9610.relatedTowns, function(_0x3aad77, _0xdc6007) {
       ...
       , startFarming: function(_0x581516) {
                if (!farm_object.checkEnabled()) return false;
                farm_object.town = _0x581516, farm_object.shouldFarm = [], farm_object.iTown = ITowns.towns[farm_object.town.id];
                var _0x371d8c = function() {
                    farm_object.interval = setTimeout(function() {
                        console_object.Log(farm_object.town.name + " getting farm information.", 1), farm_object.isCaptain ? farm_object.initFarmTownsCaptain(function() {
                            if (!farm_object.checkEnabled()) return false;
                            farm_object.claimResources();
                        }) : farm_object.initFarmTowns(function() {
                            if (!farm_object.checkEnabled()) return false;
                            farm_object.town.currentFarmCount = 0, farm_object.claimResources();
                        });
                    }, autobot_object.randomize(1e3, 2e3));
                };
                _0x35174a.currentTown !== farm_object.town.key ? farm_object.interval = setTimeout(function() {
                    console_object.Log(farm_object.town.name + " move to town.", 1), api_object.switch_town(farm_object.town.id, function() {
                        if (!farm_object.checkEnabled()) return false;
                        _0x35174a.currentTown = farm_object.town.key, _0x371d8c();
                    }), farm_object.town.isSwitched = true;
                }, autobot_object.randomize(1e3, 2e3)) : _0x371d8c();
            }, 
            initFarmTowns: function(_0x41d050) {
                api_object.game_data(farm_object.town.id, function(_0x5d0fab) {
                    if (!farm_object.checkEnabled()) return false;
                    ...
                    $.each(_0x364e4d, function(_0x6d414d, _0x3e7771) {
                        ...
                        $.each(_0x3e7771.towns, function(_0x49ba54, _0x4c62b9) {
                            _0x4c62b9.x === farm_object.iTown.getIslandCoordinateX() && _0x4c62b9.y === farm_object.iTown.getIslandCoordinateY() && 1 === _0x4c62b9.relation_status && _0x3168fd.push(_0x4c62b9);
                        }), farm_object.town.farmTowns = _0x3168fd;
                    }), $.each(farm_object.town.farmTowns, function(_0x53149b, _0x106be3) {
                        _0x106be3.loot - Timestamp.now() <= 0 && farm_object.shouldFarm.push(_0x106be3);
                    }), _0x41d050(true);
                });
            }, 
            initFarmTownsCaptain: function(_0x2ca26c) {
                api_object.farm_town_overviews(farm_object.town.id, function(_0x45ccea) {
                    if (!farm_object.checkEnabled()) return false;
                    var _0x590a31 = [];
                    $.each(_0x45ccea.farm_town_list, function(_0x21fc27, _0x38ec65) {
                        _0x38ec65.island_x === farm_object.iTown.getIslandCoordinateX() && _0x38ec65.island_y === farm_object.iTown.getIslandCoordinateY() && 1 === _0x38ec65.rel && _0x590a31.push(_0x38ec65);
                    }), farm_object.town.farmTowns = _0x590a31, $.each(farm_object.town.farmTowns, function(_0x363227, _0x2eb942) {
                        _0x2eb942.loot - Timestamp.now() <= 0 && farm_object.shouldFarm.push(_0x2eb942);
                    }), _0x2ca26c(true);
                });
            }, 
            claimResources: function() {
                if (!farm_object.town.farmTowns[0]) return console_object.Log(farm_object.town.name + " has no farm towns.", 1), farm_object.finished(1800), false;
                if (farm_object.town.currentFarmCount < farm_object.shouldFarm.length) farm_object.interval = setTimeout(function() {
                    var _0x3f8594 = "normal";
                    if (Game.features.battlepoint_villages || (farm_object.shouldFarm[farm_object.town.currentFarmCount].mood >= 86 && farm_object.settings.stoplootbelow && (_0x3f8594 = "double"), farm_object.settings.stoplootbelow || (_0x3f8594 = "double")), farm_object.isCaptain) {
                        var _0x403dbc = [];
                        $.each(farm_object.shouldFarm, function(_0x54c7bd, _0x54dbf3) {
                            _0x403dbc.push(_0x54dbf3.id);
                        }), farm_object.claimLoads(_0x403dbc, _0x3f8594, function() {
                            if (!farm_object.checkEnabled()) return false;
                            farm_object.finished(farm_object.getMethodTime(farm_object.town.id));
                        });
                    } else farm_object.claimLoad(farm_object.shouldFarm[farm_object.town.currentFarmCount].id, _0x3f8594, function() {
                        if (!farm_object.checkEnabled()) return false;
                        farm_object.shouldFarm[farm_object.town.currentFarmCount].loot = Timestamp.now() + farm_object.getMethodTime(farm_object.town.id), _0x35174a.updateTimer(farm_object.shouldFarm.length, farm_object.town.currentFarmCount), farm_object.town.currentFarmCount++, farm_object.claimResources();
                    });
                }, autobot_object.randomize(1e3 * farm_object.settings.timebetween, 1e3 * farm_object.settings.timebetween + 1e3));
                else {
                    var _0x3d4183 = null;
                    $.each(farm_object.town.farmTowns, function(_0x447e8d, _0x16ada7) {
                        var _0x326b96 = _0x16ada7.loot - Timestamp.now();
                        (null == _0x3d4183 || _0x326b96 <= _0x3d4183) && (_0x3d4183 = _0x326b96);
                    }), farm_object.shouldFarm.length > 0 ? $.each(farm_object.shouldFarm, function(_0x49dbab, _0x2aed25) {
                        var _0x5800e9 = _0x2aed25.loot - Timestamp.now();
                        (null == _0x3d4183 || _0x5800e9 <= _0x3d4183) && (_0x3d4183 = _0x5800e9);
                    }) : console_object.Log(farm_object.town.name + " not ready yet.", 1), farm_object.finished(_0x3d4183);
                }
            }, 
            claimLoad: function(_0x416b67, _0x45d412, _0x5561dd) {
                Game.features.battlepoint_villages ? api_object.frontend_bridge(farm_object.town.id, {
                    ...
                    farm_object.claimLoadCallback(_0x416b67, _0x282ed1), _0x5561dd(_0x282ed1);
                }) : api_object.claim_load(farm_object.town.id, _0x45d412, farm_object.getMethodTime(farm_object.town.id), _0x416b67, function(_0x349658) {
                    farm_object.claimLoadCallback(_0x416b67, _0x349658), _0x5561dd(_0x349658);
                });
            }, 
            ...
            claimLoads: function(_0x241485, _0x5d4fce, _0x117d8a) {
                api_object.claim_loads(farm_object.town.id, _0x241485, _0x5d4fce, farm_object.getMethodTime(farm_object.town.id), function(_0x619058) {
                    farm_object.claimLoadsCallback(_0x619058), _0x117d8a(_0x619058);
                });
            }, 
            getMethodTime: function(_0x37bd66) {
                if (Game.features.battlepoint_villages) {
                    var _0x1ef234 = farm_object.settings.method;
                    return $.each(MM.getOnlyCollectionByName("Town").getTowns(), function(_0xa63d0b, _0x2f22f2) {
                        if (_0x2f22f2.id === _0x37bd66 && _0x2f22f2.getResearches().hasResearch("booty")) return _0x1ef234 = 2 * farm_object.settings.method, false;
                    }), _0x1ef234;
                }
            ...
            finished: function(_0x5ad799) {
                if (!farm_object.checkEnabled()) return false;
                $.each(_0x35174a.playerTowns, function(_0x87b207, _0x43f8b7) {
                    -1 !== farm_object.town.relatedTowns.indexOf(_0x43f8b7.id) && (_0x43f8b7.modules.Autofarm.isReadyTime = Timestamp.now() + _0x5ad799);
                }), farm_object.town.modules.Autofarm.isReadyTime = Timestamp.now() + _0x5ad799, _0x35174a.Queue.next();
            }, 
            stop: function() {
                clearInterval(farm_object.interval);
            }, 
            init: function() {
                console_object.Log("Initialize AutoFarm", 1), farm_object.initButton(), farm_object.checkCaptain();
            }, 
            initButton: function() {
                _0x35174a.initButtons("Autofarm");
            }, 
            checkCaptain: function() {
                $(".advisor_frame.captain div").hasClass("captain_active") && (farm_object.isCaptain = true);
            }, 
                ...
                return $("<fieldset/>", {
                    ...
                    var _0x2e34de = menu_object.button({
                        ...
                        farm_object.settings.autostart = void 0 !== _0x7a93d.autofarm_autostart, farm_object.settings.method = parseInt(_0x7a93d.autofarm_method), farm_object.settings.timebetween = parseInt(_0x7a93d.autofarm_bewteen), farm_object.settings.skipwhenfull = void 0 !== _0x7a93d.autofarm_warehousefull, farm_object.settings.lowresfirst = void 0 !== _0x7a93d.autofarm_lowresfirst, farm_object.settings.stoplootbelow = void 0 !== _0x7a93d.autofarm_loot, api_object.Auth("saveAutofarm", {
                            ...
                            world_id: autobot_object.Account.world_id,
                            csrfToken: autobot_object.Account.csrfToken,
                            autofarm_settings: autobot_object.stringify(farm_object.settings)
                        }, farm_object.callbackSave);
                    });
