...
var farm_object = {
    ...
    claimResources: function() {
        ...
        farm_object.interval = setTimeout(function() {
            ...
            } else farm_object.claimLoad(farm_object.shouldFarm[farm_object.town.currentFarmCount].id, type, function() {
                if (!farm_object.checkEnabled()) return false;
                console_object.Log(farm_object.shouldFarm[farm_object.town.currentFarmCount].id + " getting farm information.", 1);
