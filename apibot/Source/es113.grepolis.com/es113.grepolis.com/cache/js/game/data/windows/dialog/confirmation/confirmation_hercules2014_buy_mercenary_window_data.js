...
(function() {
    ...
    ConfirmationData.prototype.getQuestion = function() {
        return this.l10n.question(this.props.cost, this.props.name);
    };

    ConfirmationData.prototype.getType = function() {
        return 'hercules2014_buy_mercenary';
    };
    ...
    window.ConfirmationHercules2014BuyMercenaryWindowData = ConfirmationData;
}());