...
(function() {
    ...
    ConfirmationData.prototype.getQuestion = function() {
        return this.l10n.question(this.props.cost, this.props.num, this.props.name);
    };

    ConfirmationData.prototype.getType = function() {
        return 'assassins_buy_arrows';
    };
    ...
    window.ConfirmationAssassinsBuyArrowsWindowData = ConfirmationData;
}());