...
(function(factory) {
    ...
    (function() {
        ...
        $.position = {
            ...
            getWithinInfo: function(element) {
                var withinElement = $(element || window),
                    isWindow = $.ui.isWindow(withinElement[0]),
        ...
        $.fn.position = function(options) {
            ...
            /* adjusted to use getBoundingClientRect as we need the correct element-dimensions after scaling */
            return this.each(function() {
                var collisionPosition, using,
                    elem = $(this),
                    elem_rect = elem[0].getBoundingClientRect(),
                    elemWidth = elem_rect.width,
                    elemHeight = elem_rect.height,
                ...
                position.left *= elem.offset().left === 0 ? scaling : 1;
                position.top *= elem.position().top === 0 ? scaling : 1;
   ...
   @return  jQuery object */
    ...
    $.widget("ui.draggable", $.ui.mouse, {
        ...
        _mouseDrag: function(event, noPropagation) {
            ...
            this.helper[0].style.left = this.position.left * this.options.scaling + "px";
    ...
    $.widget("ui.dialog", {
        ...
        _moveToTop: function(event, silent) {
            ...
            if (this.options.autoFocus && moved && !silent) {
                this._trigger("focus", event);
            }
            return moved;
        },
        ...
        _makeDraggable: function() {
            ...
            this.uiDialog.draggable({
                ...
                scaling: options.position.scaling,
