...
var main_object = {
    ...
    start: function() {
        ...
        if ($.each(main_object.playerTowns, function(index, town) {
            ...
            if (at_least_one_ready) main_object.Queue.start();
                ...
                main_object.startTimer(delta_time_progressbar, function() {
                    main_object.start();
                });
            }
        else console_object.Log("Nothing is ready yet!", 0),
            main_object.startTimer(30, function() {
                main_object.start();
            });
    },
    stop: function() {
    ...
    checkWhatToStart: function() {
        ...
        $.each(main_object.modules, function(index, module) {
            if (module.isOn && "Autoattack" !== module) i++;
        });
        if (0 === i) {
            main_object.stop();
        } else {
    ...
    Queue: {
        ...
        next: function() {
            ...
            if (element)
                ...
                if (this.queue.length <= 0)(this.total = 0, main_object.finished())
            };
        }
    },
    currentTown: null,
