        ...
        culture_object.interval = setTimeout(function() {
            ...
            api_object.building_place(culture_object.town.id, function(response) {
                ...
                ! function function_culture_callback(culture_option) {
                    ...
                    return "1" !== culture_option.element.find(".button, .button_new").data("enabled") ? (culture_i++, console_object.Log("RE HEREEEEEEEE ACA1 indice:",2), function_culture_callback(culture_options[culture_i]), false) : "1" === culture_option.element.find(".button, .button_new").data("enabled") ? (culture_object.interval = setTimeout(function() {
                    ...
                    }, (culture_i + 1) * autobot_object.randomize(1e3, 2e3)), false) : (culture_i++,console_object.Log("pasando por aca",2),  void function_culture_callback(culture_options[culture_i]));
