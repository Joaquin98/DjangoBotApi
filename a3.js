! function(_0xaf9f60) {
    ...
    function _0x425472(_0x5f21bd, _0x15e3a8) {
        for (var _0x3da4e8 = 0; _0x3da4e8 < _0x15e3a8.length; _0x3da4e8++) {
            var _0x3d409a = _0x15e3a8[_0x3da4e8];
            _0x3d409a.enumerable = _0x3d409a.enumerable || false, _0x3d409a.configurable = true, "value" in _0x3d409a && (_0x3d409a.writable = true), Object.defineProperty(_0x5f21bd, _0x3d409a.key, _0x3d409a);
        }
    }
...
`));
    ...
    var attack_object = function() {
        ...
        return _0x2bb8ae = _0x59c65a, _0x264b07 = [{
            key: "init",
            value: function() {
                console_object.Log("Initialize Autoattack", 4), _0x59c65a.initButton(), _0x397f9e.checkPremium("captain") && _0x59c65a.loadAttackQueue();
            }
        }, {
            key: "setSettings",
            ...
            value: function(_0x1a3f03, _0x267730) {
                ...
                void 0 !== _0x267730 ? _0x297dc7.message_text = _0x267730 : (_0x297dc7.is_running = true, _0x297dc7.interval = setInterval(function() {
                    if (void 0 !== _0x59c65a.attacks[_0x1a3f03]) {
                        ...
                        _0x297dc7.message = $("#attack_order_id_" + _0x297dc7.attack_id + " .attack_bot_timer"), _0x297dc7.message.html(_0x397f9e.toHHMMSS(_0x3b4107)), 300 !== _0x3b4107 && 120 !== _0x3b4107 && 60 !== _0x3b4107 || console_object.Log('<span style="color: #ff4f23;">[' + _0x59c65a.attacks[_0x1a3f03].origin_town_name + " &#62; " + _0x59c65a.attacks[_0x1a3f03].target_town_name + "] " + DM.getl10n("heroes").common.departure.toLowerCase().replace(":", "") + " " + DM.getl10n("place").support_overview.just_in + " " + hours_minutes_seconds(_0x3b4107) + ".</span>", 4), _0x59c65a.attacks[_0x1a3f03].send_at <= Timestamp.now() && (_0x297dc7.is_running = false, _0x59c65a.sendAttack(_0x59c65a.attacks[_0x1a3f03]), _0x59c65a.stopTimer(_0x297dc7));
            ...
            value: function(_0x404cbb) {
                _0x397f9e.checkPremium("captain") && (_0x59c65a.attacks = void 0 !== _0x404cbb.data.attacks ? _0x404cbb.data.attacks : []);
            }
        }, {
            key: "attackOrderRow",
            value: function(_0x2cd524, _0x3aa76c) {
                ...
                return _0x2cd524.send_at > Timestamp.now() && _0x41ea2a.hover(function() {
                    ...
                    if (_0x1e2cb9.length) return _0x1e2cb9[0].is_running ? _0x397f9e.toHHMMSS(_0x2cd524.send_at - Timestamp.now()) : _0x1e2cb9[0].message_text;
                })).append(_0x21ad71);
            }
        }, {
            key: "loadAttackQueue",
    ...
    var farm_object = function() {
        ...
        return _0x5a5b31 = _0x1c579c, _0x414e4e = [{
            ...
            value: function(_0x581516) {
                ...
                }, _0x397f9e.randomize(1e3, 2e3)) : _0x371d8c();
            }
        }, {
            key: "initFarmTowns",
            ...
            value: function() {
                ...
                }, _0x397f9e.randomize(1e3 * _0x1c579c.settings.timebetween, 1e3 * _0x1c579c.settings.timebetween + 1e3));
                else {
                    var _0x3d4183 = null;
                ...
                _0x1acd21.interval = setTimeout(function() {
                    void 0 !== _0x1acd21.settings.towns[_0x1acd21.town.id] && (console_object.Log(_0x1acd21.town.name + " getting event information.", 2), api_object.building_place(_0x1acd21.town.id, function(_0x2afe41) {
                        ...
                        ! function _0x3b8221(_0x3b5c39) {
                            ...
                            }, (_0x3ce62b + 1) * _0x397f9e.randomize(1e3, 2e3)), false) : (_0x3ce62b++, void _0x3b8221(_0x57703c[_0x3ce62b]));
                        }(_0x57703c[_0x3ce62b]);
                    }));
                }, _0x397f9e.randomize(2e3, 4e3));
            }
        }, {
    ...
    var build_object = function() {
        ...
        return _0x3a1782 = _0x2c62c9, _0x59f0c0 = [{
            ...
            value: function() {
                ...
                GameDataInstantBuy.isEnabled() && _0x2c62c9.checkInstantComplete(_0x2c62c9.town.id) ? _0x2c62c9.interval = setTimeout(function() {
                    api_object.frontend_bridge(_0x2c62c9.town.id, {
                        ...
                        }, _0x397f9e.randomize(500, 700));
                    });
                }, _0x397f9e.randomize(1e3, 2e3)) : _0x2c62c9.startQueueing();
            }
        }, {
            key: "startBuildUnits",
            value: function(_0x4708e5, _0x8cd49f) {
                ...
                if (void 0 !== _0x4708e5[_0x2c62c9.town.id])
                    if (void 0 !== _0x4708e5[_0x2c62c9.town.id]) {
                        ...
                        }, _0x397f9e.randomize(1e3, 2e3)) : (console_object.Log(_0x2c62c9.town.name + " recruiting " + _0x4b274f.count + " " + GameData.units[_0x4b274f.item_name].name_plural + " not ready.", 3), _0x2c62c9.finished());
            ...
            value: function() {
                ...
                }, _0x397f9e.randomize(1e3, 2e3)) : _0x2c62c9.finished();
            }
        }, {
            key: "getReadyTime",
        ...
        return _0x2baf0a = _0x53126f, _0xb66ef6 = [{
            ...
            value: function(_0x560602, _0x173cd2) {
                ...
                _0x53126f.interval = setInterval(function() {
                    $("#time_autobot .caption .value_container .curr").html(_0x397f9e.toHHMMSS(_0x560602)), $("#time_autobot .progress .indicator").width((_0x1db276 - _0x560602) / _0x1db276 * 100 + "%"), --_0x560602 < 0 && (clearInterval(_0x53126f.interval), _0x173cd2());
                }, 1e3);
            }
        }, {
            key: "initButtons",
            value: function(_0x273f2b) {
                ...
                _0x488ec6.removeClass("disabled"), _0x488ec6.on("click", function(_0x50cb90) {
                    if (_0x50cb90.preventDefault(), "Autoattack" === _0x273f2b && !_0x397f9e.checkPremium("captain")) return HumanMessage.error(Game.premium_data.captain.name + " " + DM.getl10n("premium").advisors.not_activated.toLowerCase() + "."), false;
                    true === _0x53126f.modules[_0x273f2b].isOn ? (_0x53126f.modules[_0x273f2b].isOn = false, _0x488ec6.removeClass("on"), _0x488ec6.find("span").mousePopup(new MousePopup("Start " + _0x273f2b)), HumanMessage.success(_0x273f2b + " is deactivated."), console_object.Log(_0x273f2b + " is deactivated.", 0), "Autofarm" === _0x273f2b ? farm_object.stop() : "Autoculture" === _0x273f2b ? culture_object.stop() : "Autobuild" === _0x273f2b ? build_object.stop() : "Autoattack" === _0x273f2b && attack_object.stop()) : false === _0x53126f.modules[_0x273f2b].isOn && (_0x488ec6.addClass("on"), HumanMessage.success(_0x273f2b + " is activated."), console_object.Log(_0x273f2b + " is activated.", 0), _0x488ec6.find("span").mousePopup(new MousePopup("Stop " + _0x273f2b)), _0x53126f.modules[_0x273f2b].isOn = true, "Autoattack" === _0x273f2b && attack_object.start()), "Autoattack" !== _0x273f2b && _0x53126f.checkWhatToStart();
            ...
            value: function(_0x130485) {
                _0x397f9e.isLogged = true, _0x397f9e.trial_time = _0x130485.trial_time, _0x397f9e.premium_time = _0x130485.premium_time, _0x397f9e.facebook_like = _0x130485.facebook_like, "" !== _0x130485.assistant_settings && _0x325bca.setSettings(_0x130485.assistant_settings), _0x397f9e.trial_time - Timestamp.now() >= 0 || true || _0x397f9e.premium_time - Timestamp.now() >= 0 ? (_0x53126f.hasPremium = true, _0x53126f.init(), farm_object.init(), farm_object.setSettings(_0x130485.autofarm_settings), culture_object.init(), culture_object.setSettings(_0x130485.autoculture_settings), build_object.init(), build_object.setSettings(_0x130485.autobuild_settings), build_object.setQueue(_0x130485.building_queue, _0x130485.units_queue, _0x130485.ships_queue), attack_object.init(), _0x53126f.checkAutostart()) : (_0x53126f.hasPremium = false, _0x53126f.init(), farm_object.init(), $("#Autoculture_onoff").mousePopup(new MousePopup(_0x53126f.requiredPrem)), $("#Autobuild_onoff").mousePopup(new MousePopup(_0x53126f.requiredPrem)), $("#Autoattack_onoff").mousePopup(new MousePopup(_0x53126f.requiredPrem)), _0x397f9e.createNotification("getPremiumNotification", "Unfortunately your premium membership is over. Please upgrade now!"));
            }
    ...
    Object.defineProperty(_0x307313, "title", {
        ...
        function() {
            ...
            var _0x3b9c10 = setInterval(function() {
                void 0 !== window.$ && $(".nui_main_menu").length && !$.isEmptyObject(ITowns.towns) && (clearInterval(_0x3b9c10), _0x307313.initWindow(), _0x307313.initMapTownFeature(), _0x307313.init());
            }, 100);
        }();
