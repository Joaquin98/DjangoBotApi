...
var build_object = {
    init: function() {
        ...
        $.Observer(GameEvents.town.town_switch).subscribe('refresh', function() {
            ...
            setTimeout(build_object.updateMainBuildingQueue,1000);
        });
    ...
    updateMainBuildingQueue: function() {
        var html_queue = $($("#building_tasks_main .ui_various_orders, .construction_queue_order_container .ui_various_orders")[1]);
