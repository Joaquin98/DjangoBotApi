...
var build_object = {
    ...
    startBuildUnits: function(unit_queue, unit_type) {
        ...
        if (void 0 !== unit_queue[build_object.town.id])
            if (void 0 !== unit_queue[build_object.town.id]) {
                var _0x4b274f = unit_queue[build_object.town.id][0];
                GameDataUnits.getMaxBuildForSingleUnit(_0x4b274f.item_name) >= _0x4b274f.count ? build_object.interval = setTimeout(function() {
                    api_object.building_barracks(build_object.town.id, {
                        ...
                        if (_0x59fc24.error) console_object.Log(build_object.town.name + " " + _0x59fc24.error, 3);
                            ...
                            console_object.Log('<span style="color: ' + ("unit" === unit_type ? "#ffe03d" : "#3dadff") + ';">Units - ' + _0x4b274f.count + " " + GameData.units[_0x4b274f.item_name].name_plural + " added.</span>", 3), api_object.Auth("removeItemQueue", {
                                player_id: autobot_object.Account.player_id,
                                world_id: autobot_object.Account.world_id,
                                csrfToken: autobot_object.Account.csrfToken,
                                town_id: build_object.town.id,
                                ...
                                type: unit_type
                            }, build_object.callbackSaveUnits($("#unit_orders_queue .ui_various_orders"), unit_type)), $(".queue_id_" + _0x4b274f.id).remove();
                        }
                        build_object.finished();
                    });
    ...
    getReadyTime: function(town_id) {
        ...
        $.each(time_left_info, function(queue_info) {
            if("building" === queue_info && void 0 !== build_object.building_queue[town_id] || 
            "unit" === queue_info && void 0 !== build_object.units_queue[town_id] || 
            "ship" === queue_info && void 0 !== build_object.ships_queue[town_id]) 
             next = queue_info;
        }); 
        ...
        return ({
            readyTime: Timestamp.now() + (left_time_next_instant_buy > 0 ? left_time_next_instant_buy : +build_object.settings.timeinterval),
            shouldStart: next
        });
    },
    stop: function() {
