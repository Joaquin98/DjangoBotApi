        ...
        init: function() {
            ...
            initWnd: function() {
                if (autobot_object.isLogged) {
                    ...
                    autobot_object.botWnd = Layout.dialogWindow.open("", autobot_object.title, 500, 350, "", false), autobot_object.botWnd.setHeight([350]), autobot_object.botWnd.setPosition(["center", "center"]);
                    var _0x1af1f8 = autobot_object.botWnd.getJQElement();
                    _0x1af1f8.append($("<div/>", {
                        class: "menu_wrapper",
                        style: "left: -50px; right: 14px"
                    }).append($("<ul/>", {
                        class: "menu_inner"
